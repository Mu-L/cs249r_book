...
\begin{tcolorbox}[
  enhanced jigsaw,
  breakable,
  pad at break*=1pt,  % tighten per-break padding (default ~3.5pt)
  ...
  title=\hspace{2.5em}\protect#2\hspace{0.5em}{\protect#3}, % Brace #3 to protect commas in titles
  % Page break handling - maintain proper spacing across breaks
  extras first={bottom=6pt},
  extras middle={top=8pt, bottom=6pt},
  extras last={top=8pt}
]}
{\end{tcolorbox}}
