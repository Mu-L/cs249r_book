...
* **Sparse storage formats**: They reduce memory once density falls below the metadata break-even point (roughly `{python} AlgorithmFoundations.csr_break_even_density_pct_str` percent density for CSR with FP32 values and INT32 indices), but sparse-kernel performance usually needs much higher sparsity, often 90–95 percent, because irregular index traversal costs throughput.
