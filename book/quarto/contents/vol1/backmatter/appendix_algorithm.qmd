...
- **Total model state: `{python} GPT2TrainingMem.model_state_gb_str`**—fits on a `{python} GPT2TrainingMem.accel_class_gb_str` GB-class A100/H100 (`{python} GPT2TrainingMem.accel_gb_str` in decimal units), but leaves only `{python} GPT2TrainingMem.remaining_gb_str` for activations.
