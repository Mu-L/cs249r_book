...
class AlgorithmFoundations:
    ...
    small_intensity_str = fmt(int(small_intensity), precision=1, commas=False)
    small_efficiency_pct_str = fmt(small_efficiency_pct, precision=1, commas=False)
    a100_ridge_str = fmt(a100_ridge, precision=1, commas=False)
    sparsity_pct_str = fmt(sparsity_pct, precision=1, commas=False)
    ...
    dense_gb_str = fmt(dense_gb, precision=1, commas=False)
    nonzeros_str = fmt(nonzeros/MILLION, precision=0, commas=False)
    sparse_mb_str = fmt(sparse_mb, precision=1, commas=False)
    ...
    csr_break_even_density_pct_str = fmt(csr_break_even_density_pct, precision=1, commas=False)
    coo_break_even_density_pct_str = fmt(coo_break_even_density_pct, precision=1, commas=False)
...
class GPT2TrainingMem:
    ...
    d_str = fmt(d, precision=1, commas=False)
    bf16_str = fmt(bf16, precision=1, commas=False)
    ...
    model_state_gb_str = fmt(model_state_gb, precision=1, commas=False)
    accel_gb_str = fmt(accel_gb, precision=1, commas=False)
    remaining_gb_str = fmt(remaining_gb, precision=1, commas=False)
    batch_small_str = fmt(batch_small, precision=1, commas=False)
    seq_len_str = fmt(seq_len, precision=1, commas=False)
    act_small_gb_str = fmt(act_small_gb, precision=1, commas=False)
    total_small_gb_str = fmt(total_small_gb, precision=1, commas=False, prefix="~")
    batch_large_str = fmt(batch_large, precision=1, commas=False)
    act_large_gb_str = fmt(act_large_gb, precision=1, commas=False, prefix="~")
```
