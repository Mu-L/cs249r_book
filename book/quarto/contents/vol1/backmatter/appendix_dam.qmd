...
class DAMTaxonomy:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    ex1_gpu_util_str = fmt(ex1_gpu_util_pct, precision=0, commas=False)
    ex1_disk_sat_str = fmt(ex1_disk_sat_pct, precision=0, commas=False)
    ...
    ex2_latency_ms_str = fmt_int(ex2_latency_s * 1000, commas=False)
    ...
    h100_fp16_tflops_str = fmt(h100_fp16_tflops_peak, precision=0, commas=False)
    ex2_model_size_gb_str = fmt(ex2_model_size_gb, precision=0, commas=False)
    ...
    ex3_imp_str = fmt(ex3_imp_pct, precision=1, commas=False)
    ex3_scaling_baseline_pred_str = fmt(ex3_scaling_baseline_pred_pct, precision=0, commas=False)
