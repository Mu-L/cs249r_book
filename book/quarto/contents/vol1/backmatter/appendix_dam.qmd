...
class DAMTaxonomy:
    ...
    h100_fp16_tflops_str = fmt(int(h100_fp16_tflops_peak), precision=0, commas=False)
    ...
    # Non-numeric label strings → MarkdownStr per recipe Rule 1 escape-hatch
    ex3_params_start_str = MarkdownStr("125M")
    ex3_params_end_str = MarkdownStr("1B")
    # Surface the suffix-bearing aliases used in prose
    ex3_scale_factor_str = fmt(8, precision=0, commas=False)
    ...
    ex3_chin_pred_str = fmt(ex3_chin_pred_pct, precision=0, commas=False)
