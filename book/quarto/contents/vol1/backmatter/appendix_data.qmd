...
class SerializationCost:
    ...
    csv_speed_str = MarkdownStr(f"~{csv_speed_mb}")
    parquet_speed_str = MarkdownStr(f"> {parquet_speed_mb:,}")
    csv_cycles_str = MarkdownStr("High")
    parquet_cycles_str = MarkdownStr("Low")
    proto_speed_str = MarkdownStr(f"~{proto_speed_mb}")
...
class DataAlgebra:
    ...
    join_network_tb_str = MarkdownStr(f"~{join_network_tb}")
```
