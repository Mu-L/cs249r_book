...
from mlsysim.core.constants import (
    ...
    Hardware.Cloud.H100.interconnect.bandwidth, LATENCY_L1_REGISTER, LATENCY_L2_CACHE, SYSTEM_MEMORY_BW,
...
class NumbersToKnow:
    ...
    gpu_bw_vs_pcie = int(h_h100.memory_bw.m_as(GB/second) / Hardware.Cloud.H100.interconnect.bandwidth.m_as(GB/second))
...
from mlsysim.core.constants import (
    Hardware.Cloud.H100.memory.l2_cache, Hardware.Cloud.TPUv5p.memory.l2_cache, Hardware.Cloud.H100.nvlink.bandwidth, Hardware.Cloud.TPUv5p.nvlink.bandwidth,
