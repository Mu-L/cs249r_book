...
class NumbersToKnow:
    ...
    bw_nvme_str = fmt(NVME_SEQUENTIAL_BW.m_as(GB/second), precision=0, commas=False)
...
class AppendixMachineSetup:
    ...
    bw_ssd_str = fmt(NVME_SEQUENTIAL_BW.m_as(GB/second), precision=0, commas=False)
    bw_net_str = fmt(Hardware.Networks.InfiniBand_NDR.bandwidth.m_as(GB/second), precision=0, commas=False)
...
class TrainingTimeRef:
    ...
    u_mfu_pct_str = fmt_int(u_mfu * 100, commas=False)
...
class LittlesLawExample:
    ...
    w_latency_ms_str = fmt_int(w_latency_s_value * 1000, commas=False)
