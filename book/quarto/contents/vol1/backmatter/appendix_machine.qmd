...
1. **~600$\times$ energy ratio**: DRAM access costs ~`{python} NumbersToKnow.dram_vs_compute_str`$\times$ more energy than an FP16 FLOP. This is why arithmetic intensity is everything.
