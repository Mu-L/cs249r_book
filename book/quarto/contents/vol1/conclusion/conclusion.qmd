...
- **Hardware**: H100 with $\text{BW}$ = `{python} ConclusionRoofline.h100_bw_tb_str` TB/s, $R_{\text{peak}} \approx$ `{python} ConclusionRoofline.h100_peak_tflops_str` FP16.
