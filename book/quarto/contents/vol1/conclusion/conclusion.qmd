...
class ConclusionRoofline:
    ...
    h100_bw_tb_str = fmt(gpu.memory_bw.m_as('TB/s'), precision=2, commas=False, suffix=" TB/s")
    h100_peak_tflops_str = fmt(gpu.peak_flops.m_as('TFLOP/s'), precision=0, commas=False, suffix=" TFLOP/s")
...
- **Compute** $(O)$: $\approx 2 \times P$ per token = `{python} ConclusionRoofline.llama_compute_gflops_str`.
