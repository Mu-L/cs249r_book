...
class ConclusionRoofline:
    ...
    h100_peak_tflops_str = fmt(gpu.peak_flops.m_as('TFLOP/s'), precision=0, commas=False)
    ...
    h100_peak_tflops_val = gpu.peak_flops.m_as('TFLOP/s')
...
# │
# │ Imports: mlsysim (Hardware), mlsysim.core.constants (H100_TOPS_INT8,
...
from mlsysim.core.constants import H100_TOPS_INT8, MOBILE_NPU_TOPS_INT8, MOBILE_TDP_W, SMARTPHONE_RAM_GB
from mlsysim.fmt import fmt, check
...
class EdgeReferenceRatios:
    ...
    # EXECUTE
    int8_peak_ratio = H100_TOPS_INT8 / mobile_int8_peak
