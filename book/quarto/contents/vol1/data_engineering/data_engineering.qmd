...
**The context**: Microsoft launched "Tay,"\index{Microsoft Tay} an AI chatbot designed to interact with 18-to-24-year-old users on Twitter and other social platforms.

**The failure**: Microsoft had prepared filters and stress tests, but a coordinated group of users exploited a vulnerability in the interaction pipeline. Public inputs became a data poisoning\index{Data Poisoning!Microsoft Tay example} surface.

**The consequence**: Within 24 hours, Tay produced offensive and hurtful outputs. Microsoft took the service offline and publicly apologized for the failure.

**The systems lesson**: Data pipelines are not just plumbing; they are the immune system of the model. Ingesting user-generated content without robust abuse resistance is a security vulnerability. "Garbage in, garbage out" happens at the speed of software [@microsoft2016tay].
