...
# │
# │ Imports: mlsysim.core.constants (*), mlsysim.book (fmt, sci, md_math),
...
from mlsysim.fmt import fmt, sci, md_math
...
class DataEngineeringSetup:
    ...
    transfer_time_10g_math = md_math(f"T = D_{{vol}}/BW \\approx {transfer_days_10g_str} \\text{{ days}}")
```
...
from mlsysim.fmt import fmt, sci, check, MarkdownStr
...
class FalsePositiveTarget:
    ...
    fpr_str = sci(target_fpr, precision=1)
