...
from mlsysim.fmt import fmt_int, fmt, fmt_sci, fmt_math, check
...
class DataEngineeringSetup:
    ...
    dram_multiplier_str = fmt_int(ENERGY_DRAM_ACCESS_PJ.m_as(ureg.picojoule) / ENERGY_FLOP_FP32_PJ.m_as(ureg.picojoule/ureg.count))
