...
class DataGravity:
    ...
    transfer_cost_str = fmt(transfer_cost, precision=0, commas=True, prefix="USD ")
    ...
    network_gbps_str = fmt(network_bw.m_as(Gbps), precision=0, commas=False, suffix=" Gbps")
    egress_cost_per_gb_str = fmt(egress_cost_gb, precision=2, commas=False, prefix="USD ", suffix="/GB")
    tpu_cost_per_hour_str = fmt(tpu_hourly_cost, precision=0, commas=False, prefix="USD ", suffix="/hour")
```
...
class BudgetAllocation:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    cost_per_label_str = fmt(cost_per_label, precision=2, commas=False, prefix="USD ", suffix="/label")
    review_overhead_pct_str = fmt(review_overhead_pct, precision=0, commas=False, suffix="%")
    labeling_k_str = fmt(labeling_budget/THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
    storage_k_str = fmt(storage_budget/THOUSAND, precision=1, commas=False, prefix="USD ", suffix="K")
    governance_k_str = fmt(governance_budget/THOUSAND, precision=1, commas=False, prefix="USD ", suffix="K")
    effective_cost_str = fmt(effective_cost, precision=2, commas=False, prefix="USD ", suffix="/label")
...
class KWSDesignConstraints:
    ...
    kws_budget_str = fmt(kws_budget/THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
...
class LabelingComputeRatio:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────
    labeling_budget_str = fmt(labeling_budget/THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
    train_cost_low_str = fmt(train_cost_low, precision=0, commas=False, prefix="USD ")
    train_cost_high_str = fmt(train_cost_high, precision=0, commas=False, prefix="USD ")
...
class GlacierRetrievalPricing:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    retrieval_cost_glacier_str = fmt(retrieval_cost_glacier, precision=2, commas=False, prefix="USD ", suffix="/GB")
    retrieval_cost_glacier_expedited_str = fmt(retrieval_cost_glacier_expedited, precision=2, commas=False, prefix="USD ", suffix="/GB")
...
class RealtimeCost:
    ...
    stream_cost_str = fmt(stream_cost_day, precision=0, commas=False, prefix="USD ", suffix="/day")
    batch_cost_str = fmt(batch_cost_day, precision=0, commas=False, prefix="USD ", suffix="/day")
    ...
    stream_cost_per_hr_str = fmt(stream_cost_per_hr, precision=2, commas=False, prefix="USD ", suffix="/hr")
...
class EtlEltCost:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    etl_spark_str = fmt(etl_spark_daily, precision=0, commas=False, prefix="USD ", suffix="/day")
    etl_storage_str = fmt(etl_storage_mo, precision=0, commas=False, prefix="USD ", suffix="/month")
    elt_storage_tb_str = fmt(elt_storage_tb, precision=0, commas=False, suffix=" TB")
    elt_storage_str = fmt(elt_storage_mo, precision=0, prefix="USD ", suffix="/month")
    elt_query_str = fmt(elt_query_mo, precision=0, commas=False, prefix="USD ", suffix="/month")
    savings_str = fmt(storage_savings_mo, precision=0, prefix="USD ", suffix="/month")
    etl_spark_monthly_str = fmt(etl_spark_monthly, precision=0, prefix="USD ", suffix="/month")
    etl_total_str = fmt(etl_total_mo, precision=0, prefix="USD ", suffix="/month")
    elt_total_str = fmt(elt_total_mo, precision=0, prefix="USD ", suffix="/month")
    total_savings_str = fmt(total_savings_mo, precision=0, prefix="USD ", suffix="/month")
    daily_raw_tb_str = fmt(daily_raw_tb, precision=0, commas=False, suffix=" TB")
    spark_per_tb_str = fmt(spark_per_tb, precision=0, commas=False, prefix="USD ", suffix="/TB")
    ...
    s3_per_tb_mo_str = fmt(s3_per_tb_mo, precision=0, commas=False, prefix="USD ", suffix="/TB/month")
    retention_days_str = fmt(retention_days, precision=0, commas=False, suffix=" days")
    query_cost_per_str = fmt(query_cost_per, precision=0, commas=False, prefix="USD ", suffix="/query")
...
class ActiveLearningBudget:
    ...
    label_budget_str = fmt(label_budget / THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
    label_cost_str = fmt(label_cost, precision=2, commas=False, prefix="USD ", suffix="/label")
    inference_cost_str = fmt(inference_cost_per_image, precision=2, commas=False, prefix="USD ", suffix="/image")
    random_labels_str = fmt(random_labels_needed / MILLION, precision=0, commas=False, suffix="M")
    random_label_cost_str = fmt(random_label_cost / THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
    ...
    active_label_cost_low_str = fmt(active_label_cost_low / THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
    active_label_cost_high_str = fmt(active_label_cost_high / THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
    full_pool_inference_cost_str = fmt(full_pool_inference_cost / THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
    active_total_low_str = fmt(active_total_low / THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
    active_total_high_str = fmt(active_total_high / THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
    compute_budget_pct_str = fmt(compute_budget_fraction * 100, precision=0, commas=False, suffix="%")
    compute_budget_str = fmt(compute_budget / THOUSAND, precision=0, commas=False, prefix="USD ", suffix="K")
...
class KWSStorageEconomics:
    ...
    storage_s3_cost_str = fmt(storage_s3_cost, precision=1, commas=False, prefix="USD ", suffix="/month")
    storage_nvme_low_cost_str = fmt(storage_nvme_low_cost, precision=1, commas=False, prefix="USD ", suffix="/month")
    storage_nvme_high_cost_str = fmt(storage_nvme_high_cost, precision=1, commas=False, prefix="USD ", suffix="/month")
