...
class ClinicalLabelingEconomics:
    ...
    review_rate_range_str = f"{review_rate_low}–{review_rate_high}"
    hourly_rate_range_str = f"{hourly_rate_low}–{hourly_rate_high}"
...
class KwsDataSelectionCalc:
    ...
    target_samples_plus_str = f"{target_samples_str}+"
    ...
    cost_per_sample_range_str = f"{cost_per_sample_low}–{cost_per_sample_high}"
...
class SelectionBottleneckAnchor:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    dataset_size_str = fmt(dataset_size_m, precision=0, commas=False) + "M"
