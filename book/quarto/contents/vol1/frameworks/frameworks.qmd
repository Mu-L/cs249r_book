...
class DispatchTax:
    ...
    small_tax_pct_str = fmt_int(round(small_tax_pct), commas=False)
    large_tax_pct_str = fmt_int(round(large_tax_pct), commas=False)
```
...
class DispatchTaxSmallLarge:
    ...
    dispatch_us_per_op_str = fmt(small_dispatch_us, precision=0, commas=False)
    ...
    dispatch_overhead_pct_str = fmt_int(round(small_overhead_pct), commas=False)
    dispatch_compilation_speedup_str = fmt(small_speedup_limit, precision=1, commas=False)

    gpt3_hw_time_us_str = fmt(large_hw_us, precision=0, commas=False)
    gpt3_sw_time_us_str = fmt(large_dispatch_us, precision=0, commas=False)
...
class DeviceBandwidthHierarchy:
    ...
    nvlink_a100_per_direction_gbs_str = fmt(nvlink_a100_per_direction_gbs, precision=0, commas=False)
...
class CompilationOverheadCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    resnet_compile_speedup_pct_str = fmt(resnet_compile_speedup_pct, precision=1, commas=False)
    compile_min_s_str = fmt(compile_min_s, precision=0, commas=False)
    compile_max_s_str = fmt(compile_max_s, precision=0, commas=False)
