...
**Context**: NASA's Mars Climate Orbiter depended on ground software, spacecraft software, navigation teams, and contractor interfaces agreeing on the physical meaning of exchanged values [@nasa1999marsclimateorbiter].

**Failure**: Thruster impulse data crossed an interface in English units while the navigation calculations expected metric units. The software executed, but the semantic contract attached to the numbers was broken.

**Consequence**: The trajectory estimate was wrong, the spacecraft approached Mars too low, and the mission was lost in September 1999.

**Systems lesson**: Framework abstractions are valuable because they carry contracts: shape, dtype, device placement, and sometimes units. If those contracts are implicit, correct code can still compose into a wrong system.
