...
::: {#def-frameworks-machine-learning-frameworks .callout-definition title="Machine learning frameworks"}
...
::: {#exm-frameworks-eager-vs-graph-execution-code-comparison .callout-example title="Eager vs. graph execution code comparison"}
...
::: {#def-frameworks-tensor .callout-definition title="Tensor"}
