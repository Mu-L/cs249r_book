...
| **Notebook**           | Worked calculation, typically with values computed inline from the book's constants                                         |
...
| **Lighthouse**         | Recurring workloads used as anchored case studies across multiple chapters                                                  |
...
### Margin illustrations show which layer the chapter addresses {#sec-about-margin-stack-4f5a}

At the start of every chapter, a small stack illustration in the margin of the Purpose section highlights one segment. In Volume I, the stack has eight segments and represents the ML systems stack from data engineering through deployment. In Volume II, the stack has four segments and represents the Fleet Stack, the distributed-systems layers above a single machine. The highlighted segment indicates which layer of the stack the chapter examines.
