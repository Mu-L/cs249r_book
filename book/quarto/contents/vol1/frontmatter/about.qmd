...
## Who This Book Is For {#sec-book-book-74a2}
...
## Why a Systems Textbook {#sec-book-systems-textbook-76ff}
...
The same emphasis on enduring principles shapes the book's quantitative methodology. Where possible, we replace qualitative advice ("use a smaller model") with measurable reasoning: parameter reduction must be evaluated against measured latency, memory traffic, and accuracy loss on the target hardware. Engineering decisions should be grounded in measurement, not intuition.

## What This Book Covers {#sec-book-book-covers-180b}
...
## Suggested Reading Paths {#sec-book-suggested-reading-paths-773b}
...
## A Learning Platform {#sec-about-platform}
...
This book is part of a broader learning ecosystem. Interactive Colab notebooks, lecture slides, exercises, videos, and supplementary materials for every chapter are available online at [mlsysbook.ai](https://mlsysbook.ai). Hands-on labs built with the TinyTorch educational framework are available at [mlsysbook.ai/tinytorch](https://mlsysbook.ai/tinytorch), providing guided experimentation that reinforces the concepts in each chapter.
...
## Prerequisites {#sec-book-prerequisites-1a4b}
...
## Beyond This Book {#sec-book-beyond-book-c426}

This book covers the single compute node described earlier. Topics such as distributed training strategies, fleet-scale infrastructure, production deployment at global scale, and governance challenges that arise when ML systems operate in the real world extend beyond this scope.

Completing this book therefore gives readers the prerequisite knowledge for these advanced topics.
...
## Using This Book in a Course {#sec-book-using-book-course-f71c}
...
## Copyright and Licensing {#sec-book-copyright-licensing-2538}
