...
Because that GitHub work continues, this book benefits from a continuously evolving community of contributors. The online version at [mlsysbook.ai](https://mlsysbook.ai/contents/vol1/frontmatter/acknowledgements.html) provides the complete, current list of GitHub contributors. The collaborative nature of this open-source project means new contributors join regularly. Contribution guidelines appear in the [GitHub repository](https://github.com/harvard-edge/cs249r_book).
:::

::: {.content-visible when-format="html:js"}
Reflecting that same collaborative history, a comprehensive list of all GitHub contributors follows. Contribution guidelines appear on the project [GitHub](https://github.com/harvard-edge/cs249r_book) page.
