...
*   **CPU inference**: `{python} CarbonRoiCalc.cpu_power_str` W for `{python} CarbonRoiCalc.cpu_tflops_str` (efficiency = `{python} CarbonRoiCalc.cpu_eff_str` per W).
*   **NPU inference**: `{python} CarbonRoiCalc.npu_power_str` W for `{python} CarbonRoiCalc.npu_tflops_str` (efficiency = `{python} CarbonRoiCalc.npu_eff_str` per W).
