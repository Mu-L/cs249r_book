...
The hierarchy invites an apparently simple solution: build larger, faster off-chip memory and eliminate the need for on-chip SRAM entirely. The answer is rooted in physics, specifically the *speed of light limit* on signal propagation within and between chips.
