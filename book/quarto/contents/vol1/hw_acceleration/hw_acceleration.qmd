...
from mlsysim.core.constants import (
    H100_FLOPS_INT8, count, TFLOPs, second,
...
from mlsysim.core.constants import (
    ...
    MOBILE_NPU_TOPS_INT8, count, TFLOPs, second, TRILLION,
)
...
class CpuMlInefficiency:
    ...
    mobile_tops = f"{MOBILE_NPU_TOPS_INT8.m_as(count/second)/TRILLION:.0f}"
```
...
# │ How: Read B200_FLOPS_FP4_TENSOR from constants and double
# │      for the sparse case per the constants-file comment.
# │
# │ Imports: mlsysim.core.constants (B200_FLOPS_FP4_TENSOR, PFLOPs, second)
# │ Exports: B200FP4Specs.dense_pflops_str, B200FP4Specs.sparse_pflops_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.core.constants import B200_FLOPS_FP4_TENSOR, PFLOPs, second
from mlsysim.fmt import fmt

class B200FP4Specs:
    """B200 FP4 peak throughput (dense and sparse)."""
    dense_pflops      = B200_FLOPS_FP4_TENSOR.m_as(PFLOPs/second)
