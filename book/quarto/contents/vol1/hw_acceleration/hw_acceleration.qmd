...
# │          AmdahlH100.hw_speedup_str, AmdahlH100.h100_tops_int8_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_percent, fmt, fmt_math, check
...
class AmdahlH100:
    ...
    resnet_speedup_eq_math = fmt_math(
        rf"\text{{Speedup}} = \frac{{1}}{{(1-{p_resnet_str}) + \frac{{{p_resnet_str}}}{{{hw_speedup_str}}}}} "
        rf"= \frac{{1}}{{{serial_resnet_str} + {p_resnet_per_s_str}}} "
        rf"\approx {amdahl_resnet_str}\times"
    )
    gpt2_speedup_eq_math = fmt_math(
        rf"\text{{Speedup}} = \frac{{1}}{{(1-{p_gpt2_str}) + \frac{{{p_gpt2_str}}}{{{hw_speedup_str}}}}} "
        rf"= \frac{{1}}{{{serial_gpt2_str} + {p_gpt2_per_s_str}}} "
...
`{python} AmdahlH100.resnet_speedup_eq_math`
...
`{python} AmdahlH100.gpt2_speedup_eq_math`
...
# │
# │ Imports: mlsysim.fmt (fmt, MarkdownStr)
# │ Exports: AcceleratorEfficiencyAnchor.systolic_macs_cycle_str,
