...
::: {.callout-theorem title="The fundamental limit of acceleration (Amdahl's Law)"}
...
::: {.callout-checkpoint title="The parallelism gate"}
...
::: {.callout-checkpoint title="The accelerator gate"}
...
::: {.callout-notebook title="The bandwidth taper"}
...
::: {.callout-war-story title="The 0 percent Tensor Core mystery"}
...
::: {.callout-checkpoint title="Feasibility assessment: Can you run it?"}
