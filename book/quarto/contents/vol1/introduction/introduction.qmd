...
# │ How: Compare daily search counts (SI units) and TFLOP/s density (H100 vs. CPU).
# │
...
|:--------------|:-------------------|:-----------------------------------------------------:|:-------------------------------------------------------:|:-----------------------------------------------:|
| **Cloud**     | H100 Cluster       |  `{python} DeploymentSystems.cloud_mem_str` gigabytes |  `{python} DeploymentSystems.cloud_compute_str` TFLOP/s |  `{python} DeploymentSystems.cloud_power_str` W |
| **Edge**      | Jetson Robotics    |  `{python} DeploymentSystems.edge_mem_str` gigabytes  |  `{python} DeploymentSystems.edge_compute_str` TFLOP/s  |  `{python} DeploymentSystems.edge_power_str` W  |
| **Mobile**    | Smartphone         | `{python} DeploymentSystems.mobile_mem_str` gigabytes | `{python} DeploymentSystems.mobile_compute_str` TFLOP/s | `{python} DeploymentSystems.mobile_power_str` W |
| **TinyML**    | ESP32-S3           |  `{python} DeploymentSystems.tiny_mem_str` kilobytes  |  `{python} DeploymentSystems.tiny_compute_str` TFLOP/s  |  `{python} DeploymentSystems.tiny_power_str` mW |
...
*   **Peak $(R_{\text{peak}})$**: `{python} GPT3Training.peak_tflops_str` TFLOP/s (A100 FP16 tensor core peak).
