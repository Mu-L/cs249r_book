...
class AlexNetBreakthrough:
    ...
    alexnet_params_m_str = fmt(params_m, precision=0, suffix=" M")
```
...
class ResNet50DamExample:
    ...
    memory_time_us_str = fmt_qty(p.latency_memory, US, precision=1, commas=False)
    ...
    compute_time_us_str = fmt_qty(p.latency_compute, US, precision=1, commas=False)
...
class DeploymentSystems:
    ...
    cloud_compute_str = fmt(h_cloud.peak_flops.m_as(TFLOPs/second), precision=0, suffix=" TFLOP/s")
    ...
    edge_compute_str = fmt(h_edge.peak_flops.m_as(TFLOPs/second), precision=0, suffix=" TFLOP/s")
    ...
    mobile_compute_str = fmt(h_mobile.peak_flops.m_as(TOPS), precision=0, commas=False, suffix=" TOPS")
    ...
    tiny_compute_str = fmt(h_tiny.peak_flops.m_as(TFLOPs/second), precision=4, suffix=" TFLOP/s")
...
|:--------------|:-------------------|:-------------------------------------------:|:-----------------------------------------------:|:---------------------------------------------:|
| **Cloud**     | H100 Cluster       |  `{python} DeploymentSystems.cloud_mem_str` |  `{python} DeploymentSystems.cloud_compute_str` |  `{python} DeploymentSystems.cloud_power_str` |
