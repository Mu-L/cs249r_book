...
class EmailScale:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    gmail_emails_t_str = fmt_int(gmail_emails_t_value)
```
...
class ResNet50DamExample:
    ...
    a100_hbm_tbs_str = fmt_int(a100_hbm_tbs, commas=False)
    ...
    a100_ridge_str = fmt_int(a100_ridge, commas=False)
    workload_ai_str = fmt_int(workload_ai, commas=False)
```
...
class GPT3Training:
    ...
    days_initial_str = fmt_int(days_base, commas=False)
    days_optimized_str = fmt_int(days_opt, commas=False)
    days_saved_str = fmt_int(days_saved, commas=False)
...
class EfficiencyGains:
    ...
    algo_halving_months_str = fmt_int(algo_halving_months, commas=False)
...
class AmdahlsPitfall:
    ...
    improv_pct_str = fmt_int(improvement_pct, commas=False)
    naive_p_str = fmt_int(naive_pct, commas=False)
```
