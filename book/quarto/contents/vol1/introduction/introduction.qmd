...
class AlexNetBreakthrough:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    alexnet_top5_accuracy_str = fmt(alexnet_top5_accuracy, precision=0, commas=False)
...
class GPT3TrainingEnergy:
    ...
    household_mwh_year_str = fmt(household_mwh_year, precision=0, commas=False)
```
...
class ResNet50DamExample:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    weight_mb_str = fmt(weight_mb, precision=0, commas=False)
    a100_hbm_tbs_str = fmt(a100_hbm_tbs, precision=0, commas=False)
    memory_time_us_str = fmt(memory_time_us, precision=1, commas=False)
    resnet_gflops_str = fmt(resnet_gflops, precision=0, commas=False)
    a100_peak_tflops_str = fmt(a100_peak_tflops, precision=0, commas=False)
