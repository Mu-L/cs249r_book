...
from mlsysim.core.constants import GB, MB, KB, watt, milliwatt, TFLOPs, TOPS, second, flop
...
class DeploymentSystems:
    ...
    mobile_compute_str = fmt(h_mobile.peak_flops.m_as(TOPS), precision=0, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.core.constants import (
    ENERGY_DRAM_PJ_PER_BYTE, ENERGY_FLOP_FP16_PJ, ENERGY_OP_INT8_PJ,
    byte, flop, count,
)
from mlsysim.fmt import fmt, check
