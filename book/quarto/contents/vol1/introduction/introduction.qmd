...
::: {.callout-checkpoint title="The paradigm shift"}
...
# │ Exports: GPT4ScaleEstimate.gpu_count_str, training_days_str,
# │          illustrative_gpu_days_m_str, gpu_days_m_str
# └─────────────────────────────────────────────────────────────────────────────
...
class GPT4ScaleEstimate:
    ...
    illustrative_gpu_days_m_str = fmt(illustrative_gpu_days_m, precision=1, commas=False)
...
class ResNet50DamExample:
    ...
    memory_compute_ratio_str = fmt(memory_compute_ratio, precision=1, commas=False)
```
