...
**The context**: Google Flu Trends estimated influenza activity from search queries, making it a canonical example of a data-rich predictive system built on behavioral traces rather than direct measurement.

**The failure**: The proxy drifted. Search behavior changed with media attention, product behavior, and user habits, so a model that had looked powerful against historical flu data began overstating real influenza activity.

**The consequence**: During the 2011--2013 period analyzed by researchers, the system repeatedly overpredicted flu prevalence and showed that large-scale behavioral data can amplify rather than remove measurement error.

**The systems lesson**: Data volume is not ground truth. ML systems need feedback loops to trusted measurements, drift monitoring, and skepticism about proxies whose meaning can change under the system itself [@lazer2014].
