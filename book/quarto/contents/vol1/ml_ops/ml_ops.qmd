...
**Equation**: @eq-optimal-retrain gives the optimal retraining interval $(T^*)$ that minimizes the sum of staleness losses and training costs:
...
Justify monitoring investments against incident costs using the monitoring ROI\index{Monitoring ROI!calculation} formula (@eq-monitoring-roi):
