...
class CloudEdgeTCO:
    ...
    breakeven_requests_str = fmt(breakeven_requests_per_day/1_000, precision=1, commas=False, suffix="K")
...
class VoiceAssistantWall:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    # Economics Strings
    ww_devices_b_str = fmt(ww_devices_b, precision=1, commas=False)
    ...
    vi_devices_str = fmt(vi_devices_b, precision=1, commas=False)
...
class BandwidthBottleneck:
    ...
    metadata_events_per_sec_str = fmt(metadata_events_per_sec, precision=1, commas=False)
    ...
    num_cameras_str = fmt(num_cameras, precision=1, commas=False)
