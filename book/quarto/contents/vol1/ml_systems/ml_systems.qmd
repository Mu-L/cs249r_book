...
class HardwareSpectrumSetup:
    ...
    edge_price_min_str = fmt(Hardware.Workstation.DGX_Spark.unit_cost.m_as(USD), precision=0, prefix="USD ")
...
class CloudEdgeTCO:
    ...
    gpu_price_str = fmt(gpu_price_per_hr, precision=2, commas=False, prefix="USD ", suffix="/hr")
    ...
    server_cost_str = fmt(server_cost, precision=0, prefix="USD ")
    ...
    electricity_str = fmt(electricity_per_kwh, precision=2, commas=False, prefix="USD ", suffix="/kWh")
...
class EdgeSizingFleetTCO:
    ...
    elec_cost_str = fmt(Infrastructure.Pricing.Cloud.ElectricityPerKwh.rate.m_as(USD/ureg.kilowatt_hour), precision=2, commas=False, prefix="USD ", suffix="/kWh")
...
class TcoPitfallCalc:
    ...
    cloud_compute_str = fmt(cloud_compute_value, precision=0, commas=True, prefix="USD ", suffix="/month")
