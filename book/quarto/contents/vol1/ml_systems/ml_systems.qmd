...
2. **Temperature rise**: At `{python} ThermalQuantCalc.baseline_str` W, the device temperature rises at approximately `{python} ThermalQuantCalc.temp_rise_str`$^\circ$C per second.
...
# │ Show: That a 5W workload depletes a phone battery quickly and exceeds TDP.
