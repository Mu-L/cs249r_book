...
from mlsysim.core.constants import (
    ...
    TFLOPs, TOPS, second, GB, byte, flop,
)
from mlsysim.core.formulas import calc_bottleneck
...
class ResnetMobile:
    ...
    mobile_compute_frac = fmt_frac(ResnetCloud.resnet_flops_latex, mobile_npu_flops_latex, f"{mobile_compute_ms_value:.2f}", "ms")
...
$$\text{Data Locality} \iff \frac{D_{\text{vol}}}{\text{BW}_{\text{network}}} > L_{\text{lat,network}} + \frac{O}{R_{\text{peak},\text{remote}} \cdot \eta_{\text{hw},\text{remote}}}$$
