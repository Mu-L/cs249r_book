...
# │
# │ Imports: mlsysim.core.constants (defaults.STORAGE_COST_NVME_LOW, defaults.STORAGE_COST_S3_STD, USD, GB, ureg)
...
class StorageCosts:
    ...
    # ┌── 2. EXECUTE (The Compute) ────────────────────────────────────────
    cost_nvme_gb_mo = defaults.STORAGE_COST_NVME_LOW.m_as(USD/GB/ureg.month)
    cost_s3_gb_mo   = defaults.STORAGE_COST_S3_STD.m_as(USD/GB/ureg.month)
