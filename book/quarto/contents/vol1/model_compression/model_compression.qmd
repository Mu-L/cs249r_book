...
$$
\mathcal{L}_{\text{distill}} = (1 - \gamma_{\text{KD}}) \mathcal{L}_{\text{CE}}(\mathbf{p}_{\text{student}}, y) + \gamma_{\text{KD}} \tau_{\text{distill}}^2 \text{KL}(\mathbf{p}_{\text{teacher}}^{(\tau)}, \mathbf{p}_{\text{student}}^{(\tau)})
$$
