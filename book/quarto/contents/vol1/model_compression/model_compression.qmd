...
$$
where $\mathbf{1}_{\{T_{ij} = 0\}}$ is an indicator function that yields one if $T_{ij} = 0$ and 0 otherwise, and $\Vert \cdot \Vert_0$ represents the L0 norm\index{Sparsity!L0 norm}, which counts the number of nonzero elements.
