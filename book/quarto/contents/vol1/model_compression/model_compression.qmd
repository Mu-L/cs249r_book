...
class CompressionSetup:
    ...
    energy_op_int8 = ENERGY_FLOP_INT8_PJ.m_as(ureg.picojoule/ureg.count)
    ...
    energy_int8_mac = energy_op_int8 + energy_add_int8
...
2.  **Compute work $(O \times E_{\text{compute}})$**: A 32-bit FLOP costs ≈ **`{python} CompressionSetup.energy_flop_fp32_str` pJ**. An INT8 operation costs ≈ **`{python} CompressionSetup.energy_op_int8_str` pJ**.
...
from mlsysim.core.constants import (
    ...
    count, TFLOPs, TB, second, TRILLION
)
from mlsysim.fmt import fmt, check
...
class A100Int8Speedup:
    ...
    a100_tops_int8 = A100_FLOPS_INT8.m_as(count/second) / TRILLION
...
class EnergyRatio:
    ...
    energy_add_fp32_pj = ENERGY_ADD_FP32_PJ.m_as(ureg.picojoule)
    energy_op_int8_pj = ENERGY_FLOP_INT8_PJ.m_as(ureg.picojoule/ureg.count)
    energy_add_int8_pj = ENERGY_ADD_INT8_PJ.m_as(ureg.picojoule)
