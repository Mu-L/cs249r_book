...
These energy savings take on a different character for models where memory capacity, not compute, is the binding constraint. *Deep Learning Recommendation Model (DLRM) embedding quantization* illustrates this distinction.
