...
**Scenario**: Deploying Llama 3 with `{python} QuantizationSavings.llm_params_b_str` billion parameters.
...
class A100Int8Speedup:
    ...
    a100_tops_int8 = A100_FLOPS_INT8.m_as(TFLOPs/second)
...
1. **Tensor Core throughput**: NVIDIA A100 delivers `{python} A100Int8Speedup.a100_tflops_fp16_str` TFLOP/s for FP16 vs. `{python} A100Int8Speedup.a100_tops_int8_str` TOPS (trillion INT8 operations/s) for INT8, a `{python} A100Int8Speedup.a100_int8_speedup_str`$\times$ peak throughput increase.
