...
class QuantizationSpeedup:
    ...
    mem_bw_gbs_str = fmt_int(mem_bw_gbs, commas=False)
    ...
    int4_toks_str = fmt_int(int4_toks, commas=False)
...
class QuantizationMathCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    alpha_str = fmt(alpha, precision=0, commas=False)           # "-1.0"
    beta_str = fmt(beta, precision=0, commas=False)             # "3.0"
    range_str = fmt(beta - alpha, precision=0, commas=False)    # "4.0"
    steps_str = fmt(int_steps, precision=0, commas=False)       # "255"
    scale_str = fmt(scale, precision=4, commas=False)           # "0.0157"
    zero_point_str = fmt_int(zero_point, commas=False)  # "64"
    x_val_str = fmt(x_val, precision=0, commas=False)           # "0.0"
    x_q_str = fmt_int(x_q, commas=False)          # "64"
    x_recon_str = fmt(x_recon, precision=0, commas=False)       # "0.00"
```
...
class FusionCalc:
    ...
    total_fused_mb_str = fmt_int(round(total_fused_mb), commas=False)
...
class ResNet50Int8Metrics:
    ...
    fp32_latency_ms_str = fmt_int(round(fp32_latency_ms), commas=False)
