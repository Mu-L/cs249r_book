...
\node[Box,right=of B0,fill=BrownL,draw=BrownLine](B3){Layer $N_L^S$};
...
\node[Box,right=of GB0,fill=RedL,draw=RedLine](GB3){Layer $N_L^T$};
...
- **Size**: `{python} QuantizationSavings.llm_params_b_str` $\times 10^9 \times$ `{python} QuantizationSavings.int4_bytes_str` bytes (INT4) = `{python} QuantizationSavings.int4_size_gb_str` GB
