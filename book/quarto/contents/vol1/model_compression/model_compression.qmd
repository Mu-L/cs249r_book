...
**The extreme constraint**: Our **Keyword Spotting (KWS) Lighthouse** (@sec-network-architectures-efficient-architectures-keyword-spotting-0625) lives here. Running on a microcontroller with 256 KB of SRAM means "standard" compression is not enough.
