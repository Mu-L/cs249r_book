...
class BatchingAnalysisCalc:
    ...
    b1_throughput_str = fmt_int(round(throughputs_value[1]), commas=False)
    b32_throughput_str = fmt_int(round(throughputs_value[32]), commas=False)
...
class FallacyUtilizationCalc:
    ...
    fu_p99_high_ms_str = fmt_int(round(fu_p99_high_value), commas=False)
```
