...
class DlrmLatencyCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    dlrm_input_str = fmt(dlrm_input_ms_value, precision=0, commas=False, suffix=" ms")
    dlrm_embed_str = fmt(dlrm_embed_ms_value, precision=0, commas=False, suffix=" ms")
    dlrm_mlp_str = fmt(dlrm_mlp_ms_value, precision=0, commas=False, suffix=" ms")
...
class CapacityPlanningCalc:
    ...
    mm1_p99_factor_str = fmt(mm1_p99_factor_value, precision=0, commas=False)
```
...
class ColdStartCalc:
    ...
    cs_ssd_str = fmt(cs_ssd_value, precision=0, commas=False, suffix=" s")
    ...
    cs_warmup_str = fmt(cs_warmup_value, precision=0, commas=False, suffix=" s")
```
...
class FallacyUtilizationCalc:
    ...
    fu_p99_mod_ms_str = fmt(fu_p99_mod_value, precision=0, commas=False)
    fu_p99_high_ms_str = fmt(fu_p99_high_value, precision=0, commas=False)
```
...
class TailLatencyCalc:
    ...
    tl_p99_ms_str = fmt(tl_p99_ms_value, precision=0, commas=False)
...
class FallacyCalibrationCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    fc_acc_loss_str = fmt(fc_acc_loss_pct_value, precision=0, commas=False)
