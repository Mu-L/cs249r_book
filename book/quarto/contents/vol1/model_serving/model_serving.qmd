...
class ResNetServingSpectrum:
    ...
    tiny_sram_kb_str = fmt(s_tiny.ram.m_as('KB'), precision=0)
...
$$ T_{\text{token}} \approx \frac{D_{\text{vol}}^{\text{weights}}}{\text{BW}_{\text{memory}}} $$ {#eq-token-generation-time}
