...
class DlrmLatencyCalc:
    ...
    dlrm_mlp_pct_str = fmt_int(dlrm_mlp_pct_value, commas=False)
```
...
class MobileServingCalc:
    ...
    sustained_mw_str = fmt(sustained_mw, precision=1, commas=False)
    inferences_per_battery_m_str = fmt_int(inferences_per_battery_m, commas=False)
