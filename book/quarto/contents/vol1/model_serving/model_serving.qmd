...
::: {#exm-model-serving-black-friday-traffic-spike .callout-example title="The 'Black Friday' traffic spike"}
...
::: {#def-model-serving-model-serving .callout-definition title="Model serving"}
...
::: {#def-model-serving-latency-budget .callout-definition title="Latency budget"}
...
::: {#def-model-serving-training-serving-skew .callout-definition title="Training-serving skew"}
...
::: {#exm-model-serving-resnet-50-image-preprocessing-skew .callout-example title="ResNet-50: Image preprocessing skew"}
...
::: {#def-model-serving-cold-start .callout-definition title="Cold start"}
...
::: {#def-model-serving-dynamic-batching .callout-definition title="Dynamic batching"}
...
::: {#def-model-serving-llm-performance-metrics .callout-definition title="LLM performance metrics"}
...
::: {#exm-model-serving-loading-speed-safetensors-vs-pickle .callout-example title="Loading speed: Safetensors vs. Pickle"}
...
::: {#exm-model-serving-profiling-loop .callout-example title="The profiling loop"}
...
Every token generation pays a massive "energy tax" to move the model's logic from HBM into compute registers. For comparison, on an A100 80 GB (`{python} LlmCaseStudyHwSpecs.a100_bw_tbs` TB/s HBM2e), Llama-3-8B (3.5 GB int4) generates tokens at $\approx 1.7$ ms/token. Adding more *compute cores* yields **zero** latency improvement; only faster memory (Physics) or smaller models (Algorithm) can speed up generation.
...
*   $T_{\text{token}} \approx$ `{python} LlmServingCalc.model_weight_gb_str` GB / `{python} GpuSpecs.h100_bw_tbs` TB/s ≈ `{python} LlmServingCalc.token_time_theoretical_ms_str` ms (theoretical limit).
