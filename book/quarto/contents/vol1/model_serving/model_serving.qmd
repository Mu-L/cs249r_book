...
This relationship holds regardless of arrival distribution, service time distribution, or scheduling policy. A practical capacity calculation makes the universality of the relationship easier to see.
...
Autonomous vehicles\index{Streaming Traffic!sensor synchronization}, video analytics, and robotics systems receive inputs from multiple synchronized sensors, so the serving problem becomes forming one coherent inference event from several correlated arrivals.
