...
class LatencyTableCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    l_jpeg_str = MarkdownStr(f"{l_jpeg_value:.1f} ms")
    l_resize_str = MarkdownStr(f"{l_resize_value:.1f} ms")
    l_norm_str = MarkdownStr(f"{l_norm_value:.1f} ms")
    l_transfer_str = MarkdownStr(f"{l_transfer_value:.1f} ms")
    l_inf_str = MarkdownStr(f"{l_inf_value:.1f} ms")
    l_post_str = MarkdownStr(f"{l_post_value:.1f} ms")
    l_total_str = MarkdownStr(f"{l_total_value:.1f}ms")

    p_jpeg_str = MarkdownStr(f"{p_jpeg_value:.0f}%")
    p_resize_str = MarkdownStr(f"{p_resize_value:.0f}%")
    p_norm_str = MarkdownStr(f"{p_norm_value:.0f}%")
    p_transfer_str = MarkdownStr(f"{p_transfer_value:.0f}%")
    p_inf_str = MarkdownStr(f"{p_inf_value:.0f}%")
    p_post_str = MarkdownStr(f"~{p_post_value:.0f}%")
```
...
class DlrmLatencyCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    dlrm_input_str = MarkdownStr(f"{dlrm_input_ms_value} ms")
    dlrm_embed_str = MarkdownStr(f"{dlrm_embed_ms_value} ms")
    dlrm_mlp_str = MarkdownStr(f"{dlrm_mlp_ms_value} ms")
    dlrm_post_str = MarkdownStr(f"{dlrm_post_ms_value} ms")
    dlrm_total_str = MarkdownStr(f"{dlrm_total_ms_value} ms")
```
...
class CapacityPlanningAnchor:
    ...
    slo_str = MarkdownStr(f"{slo_ms}ms")
...
class ColdStartCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    cs_local_str = MarkdownStr(f"~{cs_local_total_value:.1f} s")
    cs_cloud_str = MarkdownStr(f"~{cs_cloud_total_value:.0f} s")
    cs_ssd_str = MarkdownStr(f"{cs_ssd_value} s")
    ...
    cs_warmup_str = MarkdownStr(f"{cs_warmup_value} s")
```
...
class MobileServingCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    m_cam_ms_str = MarkdownStr(f"{m_cam_ms_value} ms")
    m_jpeg_ms_str = MarkdownStr(f"{m_jpeg_ms_value} ms")
    m_resize_ms_str = MarkdownStr(f"{m_resize_ms_value} ms")
    m_npu_ms_str = MarkdownStr(f"{m_npu_ms_value} ms")
    m_ui_ms_str = MarkdownStr(f"{m_ui_ms_value} ms")
    m_total_ms_str = MarkdownStr(f"{m_total_ms_value} ms")
    m_cam_mj_str = MarkdownStr(f"{m_cam_mj_value:.2f} mJ")
    m_jpeg_mj_str = MarkdownStr(f"{m_jpeg_mj_value:.1f} mJ")
    m_resize_mj_str = MarkdownStr(f"{m_resize_mj_value:.1f} mJ")
    m_npu_mj_str = MarkdownStr(f"{m_npu_mj_value:.1f} mJ")
    m_ui_mj_str = MarkdownStr(f"{m_ui_mj_value:.1f} mJ")
    m_total_mj_str = MarkdownStr(f"{m_total_mj_value:.1f} mJ")
```
