...
class CompressionSetup:
    ...
    smartphone_ram_str = MarkdownStr(f"{smartphone_ram_gb}")
    mcu_ram_str = MarkdownStr(f"{mcu_ram_kb}")
...
class MobileNetCompressionAnchor:
    ...
    pruning_pct_str = MarkdownStr(f"{pruning_pct}%")
    original_size_str = MarkdownStr(f"{original_size_mb}MB")
    pruned_size_str = MarkdownStr(f"{pruned_size_mb}MB")
```
