...
# │
# │ Imports: mlsysim (Hardware.Cloud.A100.tdp), mlsysim.core.constants (CARBON_PER_GPU_HR_KG, watt, ureg)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.core.constants import CARBON_PER_GPU_HR_KG, watt, ureg
...
class CarbonFactor:
    ...
    carbon_per_gpu_hr = CARBON_PER_GPU_HR_KG

    # ┌── 2. EXECUTE (The Compute) ────────────────────────────────────────
    gpu_power_kw = gpu_power.m_as(watt) / 1_000
...
class TCOCalc:
    ...
    t_total_k_str = fmt(train_tco_3yr/THOUSAND, precision=0, commas=False, prefix="$", suffix="K")
    ...
    i_gpu_hr_day_str = fmt(inf_gpu_hours_day, precision=0, commas=False, suffix=" GPU-hr")
    i_daily_carbon_str = fmt(inf_carbon_day, precision=0, commas=False, suffix=" kg")
    ...
    i_annual_carbon_str = fmt(inf_carbon_3yr/3, precision=0, suffix=" kg")
    i_total_str = fmt(inf_tco_3yr/MILLION, precision=2, commas=False, prefix="$", suffix="M")
    i_carbon_str = fmt(inf_carbon_3yr, precision=0, suffix=" kg")
    ...
    i_annual_cost_k_str = fmt(inf_cost_day * DAYS_PER_YEAR / THOUSAND, precision=0, commas=False)
    ...
    total_carbon_tons_str = fmt(total_carbon_kg/THOUSAND, precision=0, commas=False, prefix="~", suffix=" tons")  # kg → metric ton; mlsysim mass pint units pending
...
class TCOSummary:
    ...
    quant_savings_str = fmt(savings_dollars / THOUSAND, precision=0, commas=False) # In K$
    quant_carbon_str = fmt(savings_carbon_kg / THOUSAND, precision=0, commas=False) # In metric tons; kg -> metric ton, mlsysim mass pint units pending
...
class CarbonScaleCalc:
    ...
    cars_eq_str           = fmt(cars_equivalent, precision=0, commas=False)
