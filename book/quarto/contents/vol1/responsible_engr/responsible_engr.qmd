...
# │
# │ Imports: mlsysim.core.constants (CLOUD_GPU_TRAINING_PER_HOUR, CLOUD_GPU_INFERENCE_PER_HOUR)
...
# │
# │ Imports: mlsysim.core.constants (Hardware.Cloud.A100.tdp, CARBON_PER_GPU_HR_KG, watt, ureg)
...
class TCOTrainingCalc:
    # ┌── 1. LOAD (Constants) ──────────────────────────────────────────────
    train_gpu_rate = CLOUD_GPU_TRAINING_PER_HOUR.m_as(USD/hour)
    inf_gpu_rate = CLOUD_GPU_INFERENCE_PER_HOUR.m_as(USD/hour)
    carbon_per_gpu_hr = CARBON_PER_GPU_HR_KG.m_as(ureg.kilogram)
    t_data_prep_hrs = 100
    t_hparam_exps = 50
...
class CarbonScaleCalc:
    ...
    # ┌── 1. LOAD (Constants) ──────────────────────────────────────────────
    train_energy_mwh = GPT3_TRAINING_ENERGY_MWH
