...
class RepresentationStats:
    ...
    repr_group_fraction_pct_str = fmt(int(minority_fraction * 100), precision=0, commas=False)
    repr_group_fraction_str = fmt(minority_fraction, precision=2, commas=False)
    repr_random_total_str = fmt(int(random_total), precision=0)
    repr_multiplier_str = fmt(int(multiplier), precision=0, commas=False)
...
# │
# │ Imports: mlsysim.core.constants (A100_TDP, CARBON_PER_GPU_HR_KG, watt, ureg)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.core.constants import A100_TDP, CARBON_PER_GPU_HR_KG, watt, ureg
from mlsysim.fmt import fmt, check
...
class CarbonFactor:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    gpu_power_w_str = fmt(gpu_power.m_as(watt), precision=0, commas=False)
...
class TCOSummary:
    ...
    quant_reduction_pct_str = fmt(int(quant_reduction_pct * 100), precision=0, commas=False)
```
