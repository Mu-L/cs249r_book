...
# │
# │ Imports: mlsysim.core.constants (defaults.CLOUD_GPU_TRAINING_PER_HOUR, defaults.CLOUD_GPU_INFERENCE_PER_HOUR)
...
class InferenceCostCalc:
    ...
    # ┌── 1. LOAD (Constants) ──────────────────────────────────────────────
    gpu_rate_value       = defaults.CLOUD_GPU_TRAINING_PER_HOUR.m_as(USD/hour)
    ...
    gpu_inf_rate_value  = defaults.CLOUD_GPU_INFERENCE_PER_HOUR.m_as(USD/hour)
...
# │
# │ Imports: mlsysim.core.constants (Hardware.Cloud.A100.tdp, defaults.CARBON_PER_GPU_HR_KG, watt, ureg)
...
class TCOTrainingCalc:
    # ┌── 1. LOAD (Constants) ──────────────────────────────────────────────
    train_gpu_rate = defaults.CLOUD_GPU_TRAINING_PER_HOUR.m_as(USD/hour)
    inf_gpu_rate = defaults.CLOUD_GPU_INFERENCE_PER_HOUR.m_as(USD/hour)
    carbon_per_gpu_hr = defaults.CARBON_PER_GPU_HR_KG.m_as(ureg.kilogram)
    t_data_prep_hrs = 100
    t_hparam_exps = 50
...
class CarbonScaleCalc:
    ...
    carbon_intensity_g_kwh = defaults.CARBON_US_AVG_GCO2_KWH
