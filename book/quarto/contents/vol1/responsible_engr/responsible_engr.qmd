...
class TCOCalc:
    ...
    t_data_prep_carbon_str = fmt(t_data_prep_hrs * carbon_per_gpu_hr, precision=1, commas=False, suffix=" kg")
    t_hparam_carbon_str = fmt((t_hparam_exps * t_hparam_cost_exp/train_gpu_rate) * carbon_per_gpu_hr, precision=1, commas=False, suffix=" kg")
    t_final_carbon_str = fmt(t_final_hrs * carbon_per_gpu_hr, precision=1, commas=False, suffix=" kg")
    t_subtotal_carbon_str = fmt(train_carbon_cycle, precision=1, commas=False, suffix=" kg")
    t_total_carbon_str = fmt(train_carbon_3yr, precision=1, suffix=" kg")
