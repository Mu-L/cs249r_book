...
**Context**: Researchers at Mount Sinai Hospital trained a neural network to detect pneumonia in chest X-rays [@zech2018variable]. The model achieved superhuman accuracy on the test set.
