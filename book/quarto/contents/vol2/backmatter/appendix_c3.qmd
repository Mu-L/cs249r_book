...
class C3Taxonomy:
    ...
    # Case 1
    case1_n_gpus_str = fmt(case1_n_gpus, precision=1)
    ...
    case1_wasted_pct_str = fmt(case1_wasted_pct, precision=1, commas=False)

    # Case 2
    case2_baseline_gpus_str = fmt(case2_baseline_gpus, precision=1, commas=False)
    case2_n_gpus_str = fmt(case2_n_gpus, precision=1)
    case2_observed_speedup_str = fmt(case2_observed_speedup, precision=1, commas=False)
    case2_ideal_speedup_str = fmt(case2_ideal_speedup, precision=1, commas=False)
    ...
    gpus_per_host_str = fmt(GPUS_PER_HOST, precision=1, commas=False)

    # Case 3
    case3_n_gpus_str = fmt(case3_n_gpus, precision=1)
    case3_failure_interval_hours_str = fmt(case3_failure_interval_hours, precision=1, commas=False)
    ...
    # Effective FLOP/s
    peak_pflops_str = fmt(peak_pflops, precision=1)
