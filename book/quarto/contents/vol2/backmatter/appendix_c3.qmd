...
|:------------------|:-------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|:---------------------------------------|:---------------------------------------|
| **Computation**   | **MFU**                                          | $\frac{C_{\text{step}}}{R_{\text{peak}} \times T_{\text{step}}}$                                                     | $<$ `{python} C3.mfu_low_str` percent  | $>$ `{python} C3.mfu_high_str` percent |
...
A team provisions 2,048 H100 GPUs. The cluster achieves `{python} C3.mfu_high_str` percent MFU, `{python} C3.eff_1024_str` percent scaling efficiency, and 85 percent goodput ratio. Calculate the effective FLOPs as a fraction of the peak-rate FLOP budget. If a scaling law predicts that $10^{24}$ FLOPs of training compute will reach a target loss, how many raw peak-rate FLOPs must be provisioned to account for the C$^3$ tax?
