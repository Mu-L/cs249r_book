...
class C3Scorecard:
    ...
    eff_1024_str = fmt(Literature.Scaling.Eff1024Gpu * 100, precision=0, commas=False, suffix="%")
```
...
class Exercise2:
    ...
    comm_pct_str = fmt(comm_fraction * 100, precision=0, commas=False, suffix="%")
    coord_pct_str = fmt(coord_fraction * 100, precision=0, commas=False, suffix="%")
...
class Exercise3:
    ...
    # ┌── 4. OUTPUT ───────────────────────────────────────
    _eff_frac_pct_str    = fmt(_eff_frac_val * 100, precision=1, commas=False)
