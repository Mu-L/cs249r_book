...
class C3CaseStudies:
    ...
    case1_target_gain_str = fmt(MFU_TRAINING_HIGH / case1_mfu, precision=1, commas=False)
...
class C3EffectiveFlops:
    ...
    goodput_all = 1.0 - (
        ...
        + OVERHEAD_FAILURE_RECOVERY + OVERHEAD_MAINTENANCE + 0.17
    )
...
class Exercise3:
    ...
    _mfu_high_digits = fmt_int(MFU_TRAINING_HIGH * 100, commas=False)
    _eff_1024_digits = fmt_int(SCALING_EFF_1024GPU * 100, commas=False)
