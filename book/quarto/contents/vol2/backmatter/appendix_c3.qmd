...
Raising MFU from `{python} C3.case1_mfu_pct_str` percent to `{python} C3.case1_target_mfu_pct_str` percent on the same hardware delivers `{python} C3.case1_target_mfu_pct_str`/`{python} C3.case1_mfu_pct_str` = `{python} fmt(C3.case1_target_mfu/C3.case1_mfu, precision=1, commas=False)`$\times$ more useful work---the equivalent of tripling the fleet without buying a single GPU.
