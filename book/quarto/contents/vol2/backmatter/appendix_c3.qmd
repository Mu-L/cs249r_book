...
from mlsysim.fmt import fmt_percent, fmt, check, md, md_math
...
class Exercise3:
    ...
    c3_tax_math   = md_math(f"1 / {_eff_frac_3dp_str} \\approx {_c3_tax_factor_str} \\times")
    provision_math = md_math(f"{_c3_tax_factor_str} \\times 10^{{24}}")
```
