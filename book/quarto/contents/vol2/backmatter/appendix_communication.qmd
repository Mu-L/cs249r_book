...
The denominator grows by a factor of $V$ compared to @eq-pipeline-bubble. For $P$ = 8, $M$ = 16, and $V$ = 4, the bubble fraction drops from `{python} CF.bubble_std_pct_str` percent to `{python} CF.bubble_interleaved_pct_str` percent---a dramatic improvement that comes at the cost of more frequent, smaller communication between stages.
