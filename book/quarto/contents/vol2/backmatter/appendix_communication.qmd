...
class CommFoundations:
    ...
    ib_ndr_alpha_us_str = fmt(int(ib_ndr_alpha_us), precision=1, commas=False)
    ib_ndr_beta_gbs_str = fmt(int(ib_ndr_beta_gbs), precision=1, commas=False)
    ib_hdr_alpha_us_str = fmt(int(ib_hdr_alpha_us), precision=1, commas=False)
    ib_hdr_beta_gbs_str = fmt(int(ib_hdr_beta_gbs), precision=1, commas=False)
    roce_alpha_us_str = fmt(int(roce_alpha_us), precision=1, commas=False)
    roce_beta_gbs_str = fmt(roce_beta_gbs, precision=1, commas=False)
    tcp_alpha_us_str = fmt(int(tcp_alpha_us), precision=1, commas=False)
    nvlink_bw_str = fmt(nvlink_h100_bw_gbs, precision=1, commas=False)
    pcie_bw_str = fmt(pcie_gen5_bw_gbs, precision=1, commas=False)
    nvlink_lat_str = fmt(nvlink_latency_ns, precision=1, commas=False)
    pcie_lat_str = fmt(pcie_latency_ns, precision=1, commas=False)
    crossover_kb_str = fmt(round(crossover_kb_val), precision=1, commas=False)
    ring_n_str = fmt(ring_n_gpus, precision=1, commas=False)
    ring_time_ms_str = fmt(ring_time_ms, precision=1, commas=False)
    tree_time_ms_str = fmt(tree_time_ms, precision=1, commas=False)
    ring_msg_gb_str = fmt((ring_msg_bytes * byte).m_as(GB), precision=1, commas=False)
    ...
    compress_ratio_str = fmt(int(compress_ratio), precision=1, commas=False)
    ...
    nvlink_to_ndr_ratio_str = fmt(nvlink_to_ndr_ratio, precision=1, commas=False)
