...
The boundary between **Data** (memory bound) and **Machine** (compute bound) is not arbitrary; it is defined mathematically by **Arithmetic Intensity**[^fn-intensity-v2] ($I$) of the workload.
...
*   **If arithmetic intensity is below the ridge point** (about 295 FLOPs/byte on H100): The workload is likely memory bound (Data/Machine boundary).
