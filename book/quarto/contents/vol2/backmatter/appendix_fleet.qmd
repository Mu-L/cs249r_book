...
As @tbl-fleet-overhead-budgets shows, at fleet scale, four categories of overhead consume wall-clock time that is not spent on useful training:
...
# │
# │ Imports: mlsysim.fmt (fmt, fmt_percent, md_math)
...
# │
# │ Imports: mlsysim.book (fmt, fmt_percent, md)
