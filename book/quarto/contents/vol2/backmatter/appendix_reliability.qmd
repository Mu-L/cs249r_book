...
This appendix collects the reference calculations for reasoning quantitatively about failure, recovery, and availability at scale. It provides the mathematical tools behind the fault tolerance strategies in @sec-fault-tolerance-reliability, the fleet orchestration policies in @sec-fleet-orchestration, and the operational practices in @sec-ops-scale. Within the C$^3$ taxonomy (@sec-c3-taxonomy), it develops the failure-recovery and checkpointing foundations of the Coordination ($C_3$) axis.
