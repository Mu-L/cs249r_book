...
::: {.callout-notebook title="AllReduce cost for a 70B model"}
...
::: {.callout-checkpoint title="Alpha-beta diagnostics"}
...
::: {.callout-notebook title="Hiding communication behind computation"}
...
::: {.callout-notebook title="AllToAll for MoE token routing"}
...
::: {.callout-notebook title="Ring AllReduce: Step-by-step trace (4 GPUs)"}
...
::: {.callout-checkpoint title="Ring AllReduce mechanics"}
...
::: {.callout-checkpoint title="AllReduce algorithm selection"}
...
::: {.callout-notebook title="Three-level hierarchical bandwidth budget"}
...
::: {.callout-war-story title="NCCL topology discovery"}
...
::: {.callout-notebook title="Error feedback mechanism"}
...
::: {.callout-notebook title="The payback of compression"}
...
::: {.callout-checkpoint title="Gradient compression decisions"}
...
::: {.callout-notebook title="Overlap budget for a 7B transformer"}
...
::: {.callout-notebook title="Napkin math: The overlap budget"}
