...
::: {#ws-compute-infrastructure-tpu-origin-story .callout-war-story title="The TPU origin story"}
...
::: {#ws-compute-infrastructure-nvlink-bandwidth-surprise .callout-war-story title="The NVLink bandwidth surprise"}
...
- **Failure at Scale**\index{Failure!failure at scale}: A 10,000-GPU cluster experiences roughly one GPU failure every five hours. Checkpointing strategy is a first-order performance concern that must be designed into the system from the start.
