...
class H100TdpCoolingRecap:
    ...
    it_power_kw_str = fmt(it_power_kw, precision=1, commas=False)
    air_total_kw_str = fmt(air_total_kw, precision=1, commas=False)
    air_cooling_kw_str = fmt(air_cooling_kw, precision=1, commas=False)
    liquid_total_kw_str = fmt(liquid_total_kw, precision=1, commas=False)
    liquid_cooling_kw_str = fmt(liquid_cooling_kw, precision=1, commas=False)
    savings_kw_str = fmt(savings_kw, precision=1, commas=False)
