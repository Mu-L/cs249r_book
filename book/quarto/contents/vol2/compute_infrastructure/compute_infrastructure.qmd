...
# │ How: 6PD / (N_gpus * R_peak * util); apply overhead multipliers sequentially.
# │
...
class CommScalingMath:
    ...
    comm_time_formula_math = fmt_math(f"2 \\times (N-1)/N \\times 350 / {_ib_gbs}")
