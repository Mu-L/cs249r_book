...
class RooflineInferenceMath:
    ...
    inf_flops_math = md_math(f"2 \\times {InfraSetup.gpt3_params_b_str} \\times 10^9")
    inf_throughput_math = md_math(f"{InfraSetup.h100_bw_str}")
...
class PodTrainingMath:
    ...
    pod_flops_math = md_math(f"6 \\times {InfraSetup.gpt3_params_b_str} \\times 300 \\times 10^{{18}}")
    total_flops_math = md_math(f"3.15 \\times 10^{{23}}")
    n_params_math = md_math(f"P = {InfraSetup.gpt3_params_b_str} \\times 10^9")
    cluster_throughput_math = md_math(f"8{{,}}192 \\times {H100PerformanceScenario.h100_tflops_str} \\times 10^{{12}} \\times 0.45")
```
...
class CommScalingMath:
    ...
    compute_per_step_math = md_math(f"C = 6 \\times {InfraSetup.gpt3_params_b_str} \\times 10^9 \\times 2 \\times 10^6 \\approx 2.1 \\times 10^{{18}}")
