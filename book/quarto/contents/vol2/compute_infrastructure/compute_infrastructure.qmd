...
class TcoScenario:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    cloud_cost_str = fmt(fmt(cloud_node_annual, precision=0), precision=0, commas=False, prefix="$")
    annual_elec_str = fmt(fmt(annual_elec, precision=0), precision=0, commas=False, prefix="$")
    onprem_str = fmt(fmt(onprem_node_annual, precision=0), precision=0, commas=False, prefix="$")
