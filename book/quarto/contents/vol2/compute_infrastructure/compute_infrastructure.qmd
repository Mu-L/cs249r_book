...
class BandwidthHierarchyTableRecap:
    ...
    pcie_bw_str = fmt(PCIE_GEN5_BW.m_as(GB/second), precision=0, commas=False)
    ib_bw_str = fmt(INFINIBAND_NDR_BW.m_as(GB/second), precision=0, commas=False)
```
...
# │          INFINIBAND_NDR_BW, GB, second), mlsysim.fmt (check)
...
# │
# │ Imports: mlsysim.core.constants (Hardware.Cloud.H100.nvlink, INFINIBAND_NDR_BW, GB, second),
...
class InfraIbBwRackRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    ib_bw_str = fmt(INFINIBAND_NDR_BW.m_as("Gbps"), precision=0, commas=False)
```
...
class CommScalingMath:
    ...
    _ib_gbs = fmt(INFINIBAND_NDR_BW.m_as(GB/second), precision=0, commas=False)
