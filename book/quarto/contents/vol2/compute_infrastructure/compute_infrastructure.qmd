...
class PodTrainingMath:
    ...
    gpt3_tokens_b = _gpt3.training_tokens.m_as(BILLION)
    ...
    cluster_eflops = n_gpus * h100_fp8_tflops * 1e12 * mfu / 1e18
...
class TcoSummaryBreakevenRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    breakeven_util_str = fmt((dgx_h100_price / amortization_years) / denominator * 100, precision=1, commas=False)
```
