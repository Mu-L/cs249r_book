...
::: {#def-compute-infrastructure-high-bandwidth-memory-hbm .callout-definition title="High bandwidth memory (HBM)"}
...
::: {#def-compute-infrastructure-ridge-point .callout-definition title="Ridge point"}
...
::: {#exm-compute-infrastructure-roofline-analysis-training-vs-inference .callout-example title="Roofline analysis: Training vs. inference"}
...
::: {#def-compute-infrastructure-tensor-core .callout-definition title="Tensor core"}
...
::: {#def-compute-infrastructure-pipeline-bubble .callout-definition title="Pipeline bubble"}
...
::: {#def-compute-infrastructure-model-flops-utilization-mfu .callout-definition title="Model FLOPs utilization (MFU)"}
...
::: {#def-compute-infrastructure-thermal-design-power-tdp .callout-definition title="Thermal design power (TDP)"}
...
::: {#def-compute-infrastructure-node .callout-definition title="Node"}
...
::: {#def-compute-infrastructure-bandwidth-hierarchy .callout-definition title="Bandwidth hierarchy"}
...
::: {#exm-compute-infrastructure-memory-budget-175b-training-dgx-h100 .callout-example title="Memory budget for 175B training on DGX H100"}
...
::: {#def-compute-infrastructure-rack .callout-definition title="Rack"}
...
::: {#def-compute-infrastructure-power-usage-effectiveness-pue .callout-definition title="Power usage effectiveness (PUE)"}
...
::: {#def-compute-infrastructure-warehouse-scale-computer-wsc .callout-definition title="Warehouse-scale computer (WSC)"}
...
::: {#def-compute-infrastructure-scaling-efficiency .callout-definition title="Scaling efficiency"}
...
::: {#def-compute-infrastructure-hierarchy-aware-parallelism .callout-definition title="Hierarchy-aware parallelism"}
