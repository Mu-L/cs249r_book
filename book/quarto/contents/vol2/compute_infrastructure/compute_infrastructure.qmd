...
class TensorCoreH100Specs:
    ...
    # H100_FLOPS_FP16_TENSOR ever changes.
    mfu_example_tokens = 1_000
    mfu_example_pct = (
        100
        * 6
        * 7e9
        * mfu_example_tokens
        / (fp16_tc_tflops * 1e12 * 0.13)
    )
    check(32 < mfu_example_pct < 34, "MFU example should be ~33%")
    mfu_example_tokens_str = fmt(mfu_example_tokens, precision=0)
    mfu_example_math = fmt_math(
        f"\\text{{MFU}} = 6 \\times 7 \\times 10^9 \\times 10^3 / "
