...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, md_math
...
class FermiEstimate:
    ...
    machine_ops_math = md_math(f"{_machine_coeff:.2f} \\times 10^{{{_machine_exp}}}")
    ...
    brain_ops_math = md_math(f"{_brain_coeff:.1f} \\times 10^{{{_brain_exp}}}")
