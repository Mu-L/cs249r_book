...
::: {.callout-notebook title="The thundering herd: Shard contention"}
...
::: {.callout-notebook title="ROI of local NVMe caching"}
...
::: {.callout-lighthouse title="Archetype B (DLRM at Scale): Feature store latency"}
...
::: {.callout-perspective title="The IOPS bottleneck in high-dimensional search"}
