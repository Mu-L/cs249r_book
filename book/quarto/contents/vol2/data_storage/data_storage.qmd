...
The @tbl-data-formats comparison guides format selection for ML workloads.
...
For the running 175B example, tiered staging turns that synchronous burst into a short local write followed by background durability work.
