...
# │
# │ Imports: mlsysim.core.constants (defaults.STORAGE_COST_NVME_LOW)
...
class ObjectStorageCost:
    ...
    dataset_size_tb  = 100
    cost_s3_gb_mo    = 0.02
    cost_nvme_gb_mo  = defaults.STORAGE_COST_NVME_LOW.m_as("USD / GB / month")
...
# │
# │ Imports: mlsysim.core.constants (defaults.CLOUD_EGRESS_PER_GB, MILLION,
# │          defaults.STORAGE_COST_NVME_LOW)
...
class EconRatios:
    ...
    cost_nvme_gb_mo = defaults.STORAGE_COST_NVME_LOW.m_as("USD / GB / month")
    cost_s3_gb_mo   = 0.02
    cost_egress_gb  = defaults.CLOUD_EGRESS_PER_GB.m_as("USD / GB")
    dataset_size_tb = 100
...
from mlsysim.core import defaults
from mlsysim.core.constants import defaults.STORAGE_COST_NVME_LOW
from mlsysim.fmt import fmt
class ObjectStorageCostRecap:
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    s3_annual_str = fmt(100 * 1000 * 0.02 * 12, precision=0)
    nvme_annual_str = fmt(100 * 1000 * defaults.STORAGE_COST_NVME_LOW.m_as("USD / GB / month") * 12, precision=0)
```
...
class BuildVsBuyStorageEconomics:
    ...
    cloud_egress_gb = defaults.CLOUD_EGRESS_PER_GB.m_as("USD / GB")
    dataset_pb = 1
    reads_per_year = 10
...
class EconRatiosRecap:
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    tier_cost_ratio_str = fmt(defaults.STORAGE_COST_NVME_LOW.m_as("USD / GB / month") / 0.02, precision=0, commas=False)
```
