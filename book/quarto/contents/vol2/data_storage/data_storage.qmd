...
# │ Exports: (none)
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, MarkdownStr, fmt, fmt_sci, check
```
...
class StorageHierarchyAnalysis:
    ...
    nvme_bw_str                    = fmt(nvme_bw_raw.m_as(GB/second), precision=0, commas=False)
    ...
    local_nvme_capacity_tb_str     = fmt(local_nvme_capacity_tb_val, precision=0, commas=False)
    ...
    multimodal_excess_tb_str       = fmt(multimodal_excess_tb_val, precision=0, commas=False)
