...
::: {.callout-notebook title="Synchronization model trade-offs"}
...
**Result**: **OOM** on A100-`{python} DistTrainConstants.a100_mem_str` GB.
...
::: {#ws-distributed-training-linear-scaling-rule-discovery .callout-war-story title="The linear scaling rule discovery"}
...
::: {#ws-distributed-training-linear-scaling-warmup .callout-war-story title="Linear scaling warmup"}
