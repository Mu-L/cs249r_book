...
# │       Cluster MTBF is derived from canonical per-GPU defaults.GPU_MTTF_HOURS so the
# │       worked example tracks the book's single source of truth.
# │
# │ Imports: mlsysim.core.constants (defaults.GPU_MTTF_HOURS), mlsysim.book (fmt, check)
...
class YoungDaly:
    ...
    cluster_mtbf_hr = defaults.GPU_MTTF_HOURS / num_gpus  # ~48.8 hours
