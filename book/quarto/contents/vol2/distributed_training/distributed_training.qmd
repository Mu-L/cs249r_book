...
# │ Exports: (none)
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_percent, fmt, fmt_sci, check
```
...
class DistTrainConstants:
    ...
    cluster_mtbf_hours_str = fmt_int(round(cluster_mtbf_hours), commas=False)
...
class Scaling8GPU:
    ...
    nvlink_h100_str = fmt(nvlink_bw.m_as(GB/second), precision=0, commas=False)
