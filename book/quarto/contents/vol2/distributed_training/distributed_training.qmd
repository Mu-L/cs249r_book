...
::: {.callout-perspective title="Distributed training complexity"}
...
::: {.callout-checkpoint title="Data parallelism mechanics"}
...
::: {.callout-perspective title="Data parallelism at scale"}
...
::: {.callout-perspective title="Cross-reference: Communication algorithms"}
...
::: {.callout-notebook title="GPT-2 data parallel scaling"}
...
::: {.callout-notebook title="Gradient accumulation speedup"}
...
::: {.callout-notebook title="ZeRO memory savings"}
...
::: {.callout-notebook title="FSDP communication analysis"}
...
::: {.callout-notebook title="Scaling from 8 to 64 workers"}
...
::: {.callout-checkpoint title="Model parallelism foundations"}
...
::: {.callout-notebook title="The cost of the pipeline bubble"}
...
::: {.callout-perspective title="Tensor vs. pipeline parallelism: A design choice"}
...
::: {.callout-notebook title="Automated design space search (Tier 3 optimizer)"}
...
::: {.callout-checkpoint title="Hybrid 3D parallelism"}
...
::: {.callout-notebook title="RLHF infrastructure budget: PPO vs. DPO"}
