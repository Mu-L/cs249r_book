...
[^fn-parameter-server]: **Parameter Server**: Formalized by @li2014 at CMU/Google, this architecture dedicates server nodes to storing parameters while workers push gradients and pull updates, with sharding and consistency models controlling how updates are coordinated. In dense synchronous workloads, a small server tier can concentrate gradient traffic, whereas decentralized AllReduce lets each worker send and receive at its own link rate. \index{Parameter Server!architecture}
