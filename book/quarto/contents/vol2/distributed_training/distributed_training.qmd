...
- Inter-node communication: `{python} Scaling8GPU.gpt2_sync_size_gb_str` GB @ `{python} Scaling32GPU.ib_hdr_str` GB/s (10GbE) $\approx$ `{python} Scaling32GPU.inter_node_ms_str` ms
...
: **Scaling SGD Across Cluster Sizes**: Iteration count, communication overhead, wall-clock speedup, and sample efficiency for the same training job at 1, 8, and 64 GPUs. BSP scales linearly until communication dominates at 64 GPUs; SSP wins on wall-clock time at the cost of sample efficiency. {#tbl-scaling-bsp-ssp}
