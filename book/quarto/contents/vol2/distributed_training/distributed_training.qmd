...
$$
\mathbb{E}[\mathcal{L}(\theta_T)] - \mathcal{L}^{\star} \leq \mathcal{O}\left(\frac{1}{\sqrt{NbT}}\right) + \mathcal{O}\left(\frac{s^2 \eta^2 L_s^2}{Nb}\right)
$$
...
$$
\mathbb{E}[\mathcal{L}(\theta_T)] - \mathcal{L}^{\star} \leq \mathcal{O}\left(\frac{1}{\sqrt{T}}\right) + \mathcal{O}\left(\bar{\tau}_{\text{stale}}^2 \eta^2 L_s^2\right)
$$
