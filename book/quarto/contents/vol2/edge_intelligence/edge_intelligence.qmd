...
class EdgeIntelligenceSetup:
    ...
    mobile_npu_tops_str = fmt(mobile_npu_tops, precision=0, commas=False)
    h100_mem_bw_gbs_str = fmt(h100_mem_bw_gbs_int, precision=0)
    smartphone_ram_gb_str = fmt(smartphone_ram_gb, precision=0, commas=False)
```
...
class EdgeNpuSpeedup:
    ...
    npu_cpu_energy_j_str = fmt(e_cpu_j, precision=3, commas=False)
    npu_energy_j_str = fmt(e_npu_j, precision=5, commas=False)
    npu_speedup_str = fmt(speedup, precision=0, commas=False)
    npu_energy_gain_str = fmt(energy_gain, precision=0, commas=False)
```
...
class EdgeModelSizing:
    ...
    mobilenetv2_alpha10_mb_str = fmt_int(round(alpha10_mb), commas=False)
    ...
    stm32_hidden_inputs_str = fmt(stm32_hidden_inputs, precision=0, commas=False)
    ...
    tinytl_param_reduction_str = fmt(tinytl_param_reduction, precision=0, commas=False)
    brain_tops_per_w_str = fmt(brain_tops_per_w, precision=0, commas=False)
    brain_vs_npu_low_str = fmt(brain_vs_npu_low, precision=0, commas=False)
    brain_vs_npu_high_str = fmt(brain_vs_npu_high, precision=0, commas=False)
```
...
class EdgeBattery:
    ...
    battery_duration_min_str = fmt(t_train_min, precision=0, commas=False)
    ...
    battery_drain_pct_str = fmt(drain_pct, precision=0, commas=False)
    battery_total_wh_str = fmt(battery_wh, precision=0, commas=False)
```
...
class StorageWall:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    ls_contexts_str = fmt(n_contexts, precision=0, commas=False)
    ls_full_mb_str = fmt(size_full_mb, precision=0, commas=False)
    ls_adapter_kb_str = fmt(size_adapter_kb, precision=0, commas=False)
    ls_adapter_mb_str = fmt(size_adapter_mb, precision=1, commas=False)
    ls_savings_ratio_str = fmt(per_context_savings, precision=0, commas=False)
    ls_total_full_mb_str = fmt(total_full_mb, precision=0, commas=False)
    ls_total_adapter_mb_str = fmt(total_adapter_mb, precision=0, commas=False)
...
class FederatedSavings:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    fs_raw_data_mb_str = fmt(raw_data_mb, precision=0, commas=False)
    fs_update_mb_str = fmt(update_mb, precision=1, commas=False)
    fs_reduction_str = fmt(reduction, precision=0, commas=False)
```
...
class FederatedConvergence:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    fc_total_clients_str = fmt(total_clients, precision=0, commas=False)
    fc_clients_per_round_str = fmt(clients_per_round, precision=0, commas=False)
    fc_local_epochs_str = fmt(local_epochs, precision=0, commas=False)
    fc_reduced_local_epochs_str = fmt(reduced_local_epochs, precision=0, commas=False)
    fc_epsilon_str = fmt(epsilon, precision=2, commas=False)
    fc_epsilon_sq_str = fmt(epsilon_sq, precision=4, commas=False)
    fc_sigma_str = fmt(sigma, precision=0, commas=False)
    fc_beta_iid_str = fmt(beta_iid, precision=0, commas=False)
    ...
    fc_local_epochs_sq_str = fmt(local_epochs_sq, precision=0, commas=False)
    fc_reduced_local_epochs_sq_str = fmt(reduced_local_epochs_sq, precision=0, commas=False)
    fc_iid_rounds_str = fmt(iid_rounds, precision=0)
    fc_iid_client_epochs_str = fmt(iid_client_epochs, precision=0)
    fc_non_iid_rounds_str = fmt(non_iid_rounds, precision=0)
    fc_non_iid_variance_rounds_str = fmt(non_iid_variance_rounds, precision=0)
    fc_non_iid_client_epochs_str = fmt(non_iid_client_epochs, precision=0)
    fc_reduced_rounds_str = fmt(reduced_rounds, precision=0)
    fc_reduced_variance_rounds_str = fmt(reduced_variance_rounds, precision=0)
    fc_reduced_heterogeneity_rounds_str = fmt(reduced_heterogeneity_rounds, precision=0)
    fc_reduced_client_epochs_str = fmt(reduced_client_epochs, precision=0)
