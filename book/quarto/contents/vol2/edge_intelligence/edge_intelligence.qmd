...
class EdgeSmartphoneRamRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    smartphone_ram_gb_str = fmt_int(smartphone_ram_gb, commas=False)
```
...
class EdgeMobilenetSizing:
    ...
    mobilenetv2_alpha10_mb_str = fmt_int(alpha10_mb, commas=False)
    ...
    model_budget_mb = 4
    model_budget_mb_str = fmt_int(model_budget_mb, commas=False)
```
...
class EdgeH100BwRecap:
    ...
    from mlsysim.fmt import fmt_int, fmt
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    h100_mem_bw_gbs_str = fmt_int(h100_mem_bw_gbs)
```
...
class EdgeBattery:
    ...
    battery_duration_min_str = fmt_int(t_train_min, commas=False)
    ...
    battery_drain_pct_str = fmt_int(drain_pct, commas=False)
    battery_total_wh_str = fmt_int(battery_wh, commas=False)
```
...
1. **Total Energy**: `{python} EdgeBattery.battery_power_w_str` W $\times$ `{python} EdgeBattery.battery_duration_h_str` h = **`{python} EdgeBattery.battery_energy_wh_str` Wh**.
...
class StorageWall:
    ...
    ls_full_mb_str = fmt_int(size_full_mb, commas=False)
    ls_adapter_kb_str = fmt_int(size_adapter_kb, commas=False)
    ...
    ls_total_full_mb_str = fmt_int(total_full_mb, commas=False)
    ls_total_adapter_mb_str = fmt_int(total_adapter_mb, commas=False)
...
class FederatedSavings:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    fs_raw_data_mb_str = fmt_int(raw_data_mb, commas=False)
