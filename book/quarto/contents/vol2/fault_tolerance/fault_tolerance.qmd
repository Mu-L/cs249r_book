...
class MemBandwidthProtection:
    ...
    # ┌── 3. GUARD (Invariants) ────────────────────────────────────────────
    check(ddr4_eff == 44.8, f"DDR4 effective BW mismatch: {ddr4_eff}")
    check(hbm2_eff == 787.5, f"HBM2 effective BW mismatch: {hbm2_eff}")
    check(hbm3_eff == 1400, f"HBM3 effective BW mismatch: {hbm3_eff}")
