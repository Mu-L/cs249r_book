...
class SDCCollective:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    prob_str = MarkdownStr(f"{p_step_sdc*100:.4f}%")
...
class CheckpointDebug:
    ...
    per_node_gbs_str = fmt(per_node_gbs_val, precision=3, commas=False)
    per_node_mbs_str = fmt(per_node_mbs_val, precision=0, commas=False)
    serialized_min_str = fmt(serialized_min_val, precision=0)
