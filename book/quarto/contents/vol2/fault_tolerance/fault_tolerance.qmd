...
**The consequence**: The product remains usable but less personalized. This is intentional degradation, not silent success: the fallback path must be monitored so the team knows when quality is being traded for availability.
