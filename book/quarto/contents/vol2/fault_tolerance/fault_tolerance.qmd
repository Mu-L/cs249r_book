...
class YoungDalyOptimal:
    ...
    mtbf_s_str = f"{mtbf_s:,.0f}"
    radicand_str = f"{radicand:,.0f}"
    tau_opt_s_str = f"{tau_opt_s:,.0f}"
...
class CheckpointDebug:
    ...
    per_node_shard_gb_str = f"{per_node_shard_gb_val:.1f}"
    per_node_write_min_str = f"{per_node_write_min_val:.1f}"
