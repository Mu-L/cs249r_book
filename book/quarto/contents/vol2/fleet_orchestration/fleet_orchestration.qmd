...
class FleetSetup:
    ...
    spot_price_str = "0.50"
    on_demand_price_str = f"{hourly_rate:.2f}"
```
...
class SpotTrainingEconomics:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    on_demand_cost_str = f"{on_demand_cost:,.0f}"
    spot_base_cost_str = f"{spot_base_cost:,.0f}"
    checkpoint_extra_hours_str = f"{checkpoint_extra_hours:.1f}"
    restart_total_hours_str = f"{restart_total_hours:.0f}"
    spot_total_hours_str = f"{spot_total_hours:.1f}"
    spot_total_cost_str = f"{spot_total_cost:,.0f}"
    savings_str = f"{savings:,.0f}"
    savings_pct_str = f"{savings_pct:.0f}"
    longer_pct_str = f"{longer_pct:.0f}"
```
...
class ChargebackExample:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    chargeback_hours_str = f"{hours:,.0f}"
    chargeback_cost_str = f"{cost / 1000:.0f},000"
```
...
class PreemptionTax:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    recovery_minutes_str = f"{recovery_minutes:.0f}"
    cost_per_event_str = f"{cost_per_event:,.0f}"
    wasted_hours_per_day_str = f"{wasted_hours_per_day:.0f}"
    wasted_gpu_hours_per_day_str = f"{wasted_gpu_hours_per_day:,.0f}"
```
