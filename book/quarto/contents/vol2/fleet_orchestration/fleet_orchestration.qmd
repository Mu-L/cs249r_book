...
class FleetFragmentation:
    ...
    nvlink_h100_val = h_h100.memory.bandwidth.m_as(GB/second)
...
class FleetTopologyInterconnect:
    ...
    ib_ndr = Systems.Fabrics.InfiniBand_NDR
    nvlink_h100_val = h_h100.memory.bandwidth.m_as(GB/second)
    nvlink_a100_val = h_a100.memory.bandwidth.m_as(GB/second)
...
class FleetDebugNvlinkRecap:
    nvlink_a100_val = Hardware.Cloud.A100.memory.bandwidth.m_as(GB/second)
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    nvlink_a100_str = fmt(nvlink_a100_val, precision=0, suffix=' GB/s')
```
