...
class ElasticScaling:
    ...
    es_vs_wait_pct_str = fmt(elastic_vs_wait_pct, precision=1, commas=False)
...
class GpuSharingRoi:
    ...
    gs_shared_util_str = fmt(shared_util_pct, precision=0, commas=False)
...
class DiurnalGpuShift:
    ...
    ds_dynamic_util_str = fmt_int(round(dynamic_util_pct))
