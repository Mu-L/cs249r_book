...
class ClusterEconomicsContext:
    ...
    cluster_size = 10000
    gpu_hour_cost_usd = defaults.FLEET_GPU_HOUR_COST_REF.m_as(USD / hour)
    idle_fraction = 0.30
    util_low = 0.50
    util_high = 0.80
...
class GangSchedulingDeadlock:
    ...
    gpu_hour_cost = defaults.FLEET_GPU_HOUR_COST_REF.m_as(USD / hour)
...
# ┌── 2. ARRAYS ────────────────────────────────────────────────────────────────
gpu_cost_per_hour = defaults.FLEET_GPU_HOUR_COST_REF.m_as(USD / hour)
...
class FleetSpotPricing:
    hourly_rate = defaults.FLEET_GPU_HOUR_COST_REF.m_as(USD / hour)
...
class SpotTrainingEconomics:
    ...
    on_demand_rate = defaults.FLEET_GPU_HOUR_COST_REF.m_as(USD / hour)
    spot_rate = defaults.FLEET_SPOT_GPU_HOUR_COST_REF.m_as(USD / hour)
...
class GpuSharingRoi:
    ...
    gpu_rate = defaults.FLEET_GPU_HOUR_COST_REF.m_as(USD / hour)
    # ┌── 2. EXECUTE ───────────────────────────────────────
...
class ChargebackExample:
    ...
    gpus = 64
    days = 34
    gpu_hour_rate = defaults.FLEET_INTERNAL_CHARGEBACK_PER_HOUR.m_as(USD / hour)
    # ┌── 2. EXECUTE ───────────────────────────────────────
...
class PreemptionTax:
    ...
    reload_minutes = 20
    warmup_minutes = 10
    gpu_hour_rate = defaults.FLEET_GPU_HOUR_COST_REF.m_as(USD / hour)
...
# │
# │ Imports: mlsysim.core.constants (defaults.FLEET_GPU_HOUR_COST_REF)
...
class DebugValueCalc:
    ...
    _gpu_rate          = defaults.FLEET_GPU_HOUR_COST_REF.m_as(USD / hour)
