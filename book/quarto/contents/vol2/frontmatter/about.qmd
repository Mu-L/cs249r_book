...
A quantitative methodology is used throughout. Where possible, we replace qualitative advice ("use more GPUs") with measurable reasoning ("adding 512 nodes to this topology increases aggregate compute by 4$\times$ but increases AllReduce latency by 1.8$\times$, yielding a net scaling efficiency of 0.87"). Engineering decisions should be grounded in the physics of the system, not in intuition about what "should" scale.
