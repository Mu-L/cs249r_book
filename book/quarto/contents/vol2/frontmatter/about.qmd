...
Each part builds on the previous one. Sequential reading is recommended, though the reading paths below offer alternatives for readers with specific goals.
...
The book teaches the principles. The labs teach the practice. Readers are encouraged to use both.
