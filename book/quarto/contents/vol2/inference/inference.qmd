...
class BatchingWorkedExample:
    ...
    cont_avg_lat_str = MarkdownStr(f"{cont_avg_latency_ms:,}")
...
class KVCacheCalc:
    ...
    kv_fp16_gb_str = MarkdownStr(f"{kv_fp16_gb:.1f}")
    kv_int4_gb_str = MarkdownStr(f"{kv_int4_gb:.1f}")
    kv_savings_gb_str = MarkdownStr(f"{kv_savings_gb:.1f}")
    kv_compression_str = MarkdownStr(f"{kv_compression:.0f}")
