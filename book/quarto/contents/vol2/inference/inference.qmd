...
The cascade reduces final L3 evaluations by 10,000$\times$ compared to running L3 on all candidates. Under this simplified linear latency model, the full cascade is roughly 5,600$\times$ lower cost than applying L3 to the entire candidate set.
