...
::: {#tip-inference-scale-kv-cache-review .callout-tip title="Foundational review: KV cache fundamentals"}

Autoregressive generation requires storing the Key and Value tensors for all past tokens to avoid recomputing them. This KV cache grows linearly with sequence length and batch size, rapidly becoming the primary memory bottleneck in LLM serving. For the fundamental math of KV cache sizing, see @sec-appendix-systems-inference.
