...
class InferenceEconomics:
    ...
    serving_cost_total_str = MarkdownStr(f"USD {fmt(serving_total_cost_val, precision=0)}")
    training_cost_total_str = MarkdownStr(f"USD {fmt(training_total_cost, precision=0)}")
