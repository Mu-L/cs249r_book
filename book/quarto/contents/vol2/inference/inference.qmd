...
class GPT3ServingResults:
    ...
    b8_service_ms_str = fmt(b8_service_ms, precision=0, commas=False)
    b8_util_pct_str = fmt(b8_util_pct, precision=1, commas=False)
    b8_wait_ms_str = fmt(b8_wait_ms, precision=1, commas=False)
    b16_service_ms_str = fmt(b16_service_ms, precision=0, commas=False)
...
class ContinuousBatchingBenefit:
    ...
    rag_cv_str = fmt(rag_cv, precision=0, commas=False)
...
class PrefixCachingAnalysis:
    ...
    concurrent_multiplier_str = fmt_int(round(concurrent_multiplier_val), commas=False)
```
