...
# │
# │ Imports: mlsysim.core.constants (GB, Systems.Fabrics.InfiniBand_HDR.bandwidth, NETWORK_100G_BW,
# │          Hardware.Cloud.H100.nvlink.bandwidth, second), mlsysim.fmt (check, fmt)
...
class AllReduceInterconnect:
    ...
    message_mb = 8
    layer_budget_ms = 30
    nvlink_bw_gbs = Hardware.Cloud.H100.nvlink.bandwidth.m_as(GB/second)
    ib_hdr_bw_gbs = Systems.Fabrics.InfiniBand_HDR.bandwidth.m_as(GB/second)
