...
2. **Daily failure rate**\index{Failure Rate!daily}: $24 \text{ hours} /$ `{python} Gpt4TrainingScenario.mtbf_hours_str` $\text{ hours} \approx$ **`{python} Gpt4TrainingScenario.cluster_fail_day_str` failures per day**.
3. **Total annual failures**\index{Failure Rate!annualized count}: `{python} Gpt4TrainingScenario.gpt4_gpus_str` GPUs $\times$ (8{,}760 hours $/$ `{python} Gpt4TrainingScenario.gpu_mttf_str` hours) $\approx$ **`{python} Gpt4TrainingScenario.annual_fails_str` failures per year**.
