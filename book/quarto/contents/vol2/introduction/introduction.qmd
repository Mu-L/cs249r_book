...
- [ ] Can you explain why **scaling efficiency**\index{Scaling Efficiency} decreases as you add more nodes ($N_{\text{node}}$)?
...
3.  **Coordination ($C_3$ - The Logic)**\index{C³ Taxonomy!coordination}: The synchronous management of state across thousands of nodes. This is the domain of collective algorithms (All-Reduce), fault tolerance, and distributed consensus. Coordination is the "Software Tax" that determines how efficiently $N_{\text{node}}$ independent nodes can act as a single computer.
