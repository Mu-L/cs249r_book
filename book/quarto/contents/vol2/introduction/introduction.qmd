...
# │       50,000-hour per-GPU MTBF (defaults.GPU_MTTF_HOURS),
...
class Gpt4TrainingScenario:
    ...
    # defaults.GPU_MTTF_HOURS is the legacy constant name; use it as per-GPU MTBF here.
    gpu_mtbf_hours = defaults.GPU_MTTF_HOURS
