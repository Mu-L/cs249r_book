...
class Gpt4TrainingScenario:
    ...
    gpt4_days_str = fmt(gpu_days, precision=1)
    ...
    annual_fails_str = fmt(annual_failures, precision=1)
...
class Gpt3TrainingScenario:
    ...
    gpt3_gradient_gb_str = fmt(gradient_gb, precision=1, commas=False)
```
...
class InfiniBandScenario:
    ...
    ib_ndr_gbps_str = fmt(ndr_gbps, precision=1, commas=False)
    ib_hdr_gbs_str = fmt(hdr_gbs, precision=1, commas=False)
    ib_ndr_gbs_str = fmt(ndr_gbs, precision=1, commas=False)
...
class Gpt3StatsScenario:
    ...
    gpt3_params_b_str = fmt(params_b, precision=1, commas=False)
    gpt3_training_ops_str = fmt_sci(ops)
    a100_fp16_tflops_str = fmt(a100_throughput, precision=1, commas=False)
```
...
class ReliabilityGap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    node_reliability_str = fmt(p_node * 100, precision=0, commas=False, suffix=" percent")
...
class GPT3SyncTax:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    sync_size_gb_str = fmt((sync_size_bytes * byte).m_as(GB), precision=1)
    ...
    million_steps_str = fmt(million_steps, precision=1)
    sync_energy_mj_str = fmt(sync_energy_mj, precision=1)
```
...
class EdgeLatencyDistance:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    speed_kmh_str = fmt(speed_kmh, precision=1)
    delay_ms_str = fmt(delay_ms, precision=1)
...
class LinearScalingFallacy:
    ...
    # ┌── 4. OUTPUT (Formatting) ────────────────────────────────────────────
    ideal_speedup_str = fmt(ideal_speedup, precision=1)
    coord_overhead_pct_str = fmt(coord_overhead_fraction * 100, precision=1)
