...
**Systems insight**: Saving money on core switches creates a **`{python} BisectionScaling.bbs_slowdown_str`$\times$ bottleneck** for global synchronization. For a \$300M supercomputer where training is 30 percent communication, this "saving" wastes approximately **\$142 million** in idle compute time. For training, network oversubscription is a false economy.
