...
class NetworkFabricsContextScenario:
    ...
    h100_tflops_str = fmt(h100_flops_raw.m_as(TFLOPs/second), precision=0, commas=False, suffix=" TFLOPS")
...
class NetworkAlphaBeta:
    ...
    t_small_ib_us_str = fmt(t_small_ib * 1e6, precision=2, commas=False, suffix=" μs")
    small_bw_pct_str = fmt(small_bw_term_pct, precision=1, commas=False, suffix=" percent")
    t_large_ib_ms_str = fmt(t_large_ib * 1e3, precision=1, commas=False, suffix=" ms")
    ib_alpha_us_str = fmt(alpha_ib * 1e6, precision=1, commas=False, suffix=" μs")
...
class AllReduceBottleneck:
    ...
    h100_tflops_str = fmt(peak_tflops, precision=0, commas=False, suffix=" TFLOPS")
...
class FatTreeScaling:
    ...
    switch_cost_low_str = fmt(10000, precision=0, commas=False, prefix="\\$")
    switch_cost_high_str = fmt(50000, precision=0, commas=False, prefix="\\$")
...
class BisectionScaling:
    ...
    bbs_time_1_1_ms_str = fmt(time_1_1 * 1000, precision=0, suffix=" ms")
    bbs_time_4_1_ms_str = fmt(time_4_1 * 1000, precision=0, suffix=" ms")
```
...
class BisectionBottleneck:
    ...
    bisec_bw_a_tbs_str = fmt(total_bisec_bw_a / 1000, precision=1, commas=False, suffix=" TB/s")
    bisec_bw_b_tbs_str = fmt(total_bisec_bw_b / 1000, precision=1, commas=False, suffix=" TB/s")
    ...
    time_a_ms_str = fmt(time_a_s * 1000, precision=0, commas=False, suffix=" ms")
    time_b_ms_str = fmt(time_b_s * 1000, precision=0, commas=False, suffix=" ms")
...
class NextGenLinkDensity:
    ...
    eth_1_6t_port_tbps_str = fmt(eth_1_6t_port_gbps_val / 1000, precision=1, commas=False, suffix=" Tb/s")
