...
class NetworkAlphaBeta:
    ...
    eth_alpha_us = 5.0
    eth_beta_gbs = 12.5
    eth_alpha_us_str = fmt(eth_alpha_us, precision=1, commas=False)
...
class AllReduceBottleneck:
    ...
    params_1b_billion_str = fmt(m_1b.parameters.m_as(BILLION), precision=0, commas=False)
    grad_1b_gb_str = fmt(grad_1b.m_as(GB), precision=0, commas=False)
    gpu_util_pct_str = fmt(gpu_util * 100, precision=0, commas=False)
    h100_tflops_str = fmt(peak_tflops, precision=0, commas=False)
    params_70b_billion_str = fmt(m_70b.parameters.m_as(BILLION), precision=0, commas=False)
