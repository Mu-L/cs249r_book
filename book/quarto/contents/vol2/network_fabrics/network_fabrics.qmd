...
This same-rank structure is not an abstract optimization; it is the architectural pattern behind the largest dense-model fleets.
...
Violating the bisection requirement has a direct economic cost.
