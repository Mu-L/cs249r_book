...
@fig-network-topologies (below) quantifies the bandwidth and cost consequences of these topology choices: fat-trees deliver the highest bisection bandwidth at higher switch cost, rail-optimized networks trade some global flexibility for lower cost, and dragonflies reduce cabling while accepting workload-placement constraints [@kim2008].
