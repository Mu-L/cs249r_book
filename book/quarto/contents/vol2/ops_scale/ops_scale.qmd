...
class MultiTenantEfficiency:
    ...
    mt_savings_pct_str = fmt(savings_pct, precision=1, commas=False)
...
class PlatformRoi:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    pr_n_models_str = fmt(n_models, precision=1, commas=False)
    pr_savings_h_str = fmt(savings_h_per_month, precision=1, commas=False)
...
class PlatformEconomics:
    ...
    annual_cost_before_str = fmt(annual_cost_before_val, precision=1)
...
class TrainingCapacityCost:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────────────────────
    n_gpus_str = fmt(n_gpus, precision=1)
...
class MaintenanceDividend:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    md_toil_hours_str = fmt(toil_h_per_month, precision=1, commas=False)
    md_low_toil_str = fmt(low_toil_h_per_month, precision=1, commas=False)
...
class DebtPriority:
    ...
    weeks_saved_str = fmt(weeks_saved, precision=1, commas=False)
    config_savings_str = fmt(config_savings / THOUSAND, precision=1, commas=False, suffix="K")
```
...
class DeploymentRoi:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    roi_engineer_rate_str = fmt(engineer_rate, precision=1, commas=False)
    roi_manual_hours_str = fmt(manual_hours_per_deploy, precision=1, commas=False)
    ...
    automation_setup_hours_str = fmt(automation_setup_hours, precision=1, commas=False)
    deploys_per_week_str = fmt(deploys_per_week, precision=1, commas=False)
...
class DeploymentSafety:
    ...
    ds_canary_pct_str = fmt(canary_pct*100, precision=1, commas=False, suffix="%")
    ds_risk_reduction_str = fmt(risk_reduction, precision=1, commas=False)
...
class SilentFailure:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    sf_qps_str = fmt(qps, precision=1)
    sf_detection_hours_str = fmt(t_detection_h, precision=1, commas=False)
    ...
    sf_total_loss_str = fmt(total_loss, precision=1)
...
class FalseAlarmTax:
    ...
    n_monitors_str = fmt(int(n_monitors), precision=1)
    checks_per_day_str = fmt(int(checks_per_day), precision=1, commas=False)
    check_interval_min_str = fmt(check_interval_min, precision=1, commas=False)
    daily_alerts_str = fmt(daily_alerts, precision=1, commas=False)
    ...
    n_models_str = fmt(n_models, precision=1, commas=False)
    n_metrics_str = fmt(n_metrics, precision=1, commas=False)
...
class DriftLatency:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    # Custom percent suffix → MarkdownStr escape-hatch (preserves "%" appended)
    dl_base_acc_str = fmt(p1*100, precision=1, commas=False, suffix="%")
    dl_drop_str = fmt((p1-p2)*100, precision=1, commas=False, suffix="%")
    dl_samples_needed_str = fmt(int(n), precision=1)
