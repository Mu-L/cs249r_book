...
# │ How: cost = years * toil_hours * engineer_rate; maintenance = setup_cost + years * low_toil_hours * engineer_rate.
# │
# │ Imports: mlsysim.book (check)
...
# │ How: manual_cost = deployment_count * manual_hours * engineer_rate; auto_cost = setup_cost + deployment_count * auto_hours * engineer_rate.
# │
# │ Imports: mlsysim.book (check)
...
# │ How: loss = request_rate * detection_time * (CTR_base - CTR_new) * value_per_click.
# │
# │ Imports: mlsysim.book (check)
...
# │ How: n_sample = (z_alpha_sig + z_beta_stat)^2 * (p1*(1-p1) + p2*(1-p2)) / (p1 - p2)^2.
# │
# │ Imports: mlsysim.book (check)
