...
# │ How: C_{\text{shared}} = C_{\text{dedicated}}(1 - r_{\text{idle}}).
# │
...
# │ How: \text{ROI}_{\text{platform}} = N_{\text{models}} T_{\text{saved}} C_{\text{engineer}} / C_{\text{platform}}.
# │
# │ Imports: mlsysim.book (check)
...
# │ How: \text{ROI}_{\text{platform}} = N_{\text{models}} C_{\text{saved/model}} / C_{\text{platform}}; viz.setup_plot().
# │
...
# │ How: C_{\text{train}} = N_{\text{GPU}} T_{\text{train}} C_{\text{GPU-hour}}.
# │
...
# │ How: C_{\text{debt}} = T_{\text{years}} T_{\text{toil}} C_{\text{engineer}}; C_{\text{maint}} = C_{\text{setup}} + T_{\text{years}} T_{\text{low toil}} C_{\text{engineer}}.
# │
# │ Imports: mlsysim.book (check)
...
# │ How: C_{\text{manual}} = N_{\text{deploy}} T_{\text{manual}} C_{\text{engineer}}; C_{\text{auto}} = C_{\text{setup}} + N_{\text{deploy}} T_{\text{auto}} C_{\text{engineer}}.
# │
# │ Imports: mlsysim.book (check)
...
# │ How: loss = Q_{\text{req}} T_{\text{detect}} (\text{CTR}_{\text{base}} - \text{CTR}_{\text{new}}) C_{\text{click}}.
# │
# │ Imports: mlsysim.book (check)
...
# │ How: n_{\text{sample}} = (Z_{\alpha_{\text{sig}}} + Z_{\beta_{\text{stat}}})^2 * (p1*(1-p1) + p2*(1-p2)) / (p1 - p2)^2.
# │
# │ Imports: mlsysim.book (check)
