...
1. **Gross Monthly Savings**\index{Gross Monthly Savings}: `{python} PlatformRoi.pr_n_models_str` models $\times$ `{python} PlatformRoi.pr_savings_h_str` hours/model $\times$ \$150/hr = **\$`{python} PlatformRoi.pr_gross_savings_str`**.
...
1. **Status quo (`{python} MaintenanceDividend.md_years_str` years)**: `{python} MaintenanceDividend.md_months_str` months $\times$ `{python} MaintenanceDividend.md_toil_hours_str` hours/month $\times$ \$150/hr = **\$`{python} MaintenanceDividend.md_cost_toil_str`**.
2. **Proactive Path**\index{Proactive Path}: (`{python} MaintenanceDividend.md_maintenance_investment_str` hours investment + `{python} MaintenanceDividend.md_months_str` months $\times$ `{python} MaintenanceDividend.md_low_toil_str` hours/month) $\times$ \$150/hr = **\$`{python} MaintenanceDividend.md_cost_proactive_str`**.
...
2. **Weekly Savings**\index{Savings!weekly}: `{python} DeploymentRoi.hours_saved_per_deploy_str` hours/deploy $\times$ `{python} DeploymentRoi.deploys_per_week_str` deploys/week $\times$ USD `{python} DeploymentRoi.roi_engineer_rate_str`/hr = **USD `{python} DeploymentRoi.weekly_savings_str`/week**.
