...
: **Cost-Quality Tradeoff Analysis**\index{Cost!cost-quality tradeoff analysis}: Diminishing returns in model scaling. Small-to-medium model transition yields a 3 percentage-point accuracy gain for 10$\times$ cost increase; medium-to-large yields only 1 additional percentage point for another 10$\times$ cost. This pattern demonstrates why explicit cost-quality analysis should inform model selection rather than defaulting to larger architectures. {#tbl-ops-scale-cost-quality}
