...
**Systems lesson**: Semantic silence is more dangerous than loud failure: syntactically valid feature values can hide production regressions until business metrics move.
...
**Systems lesson**: Shared features need immutable versions (for example, `engagement_score_v2`) because feature semantics are production interfaces, not implementation details.
