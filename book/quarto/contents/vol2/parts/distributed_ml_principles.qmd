...
**Invariant**: The optimal checkpoint interval balances the cost of writing the checkpoint ($T_{\text{write}}$) against the expected cost of reworking lost progress due to failures ($\text{MTBF}$).
