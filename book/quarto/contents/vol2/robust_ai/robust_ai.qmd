...
**Accuracy outcome**: Gaining robustness against rare adversarial attacks sacrifices **`{python} RobustnessTaxAnalysis.acc_drop_str` age points** of clean accuracy on normal inputs.
