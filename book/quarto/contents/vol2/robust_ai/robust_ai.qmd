...
**Systems insight**: Gaining robustness against rare adversarial attacks sacrifices **`{python} RobustnessTaxAnalysis.acc_drop_str` percentage points of accuracy** on normal inputs.
