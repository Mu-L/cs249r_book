...
**Accuracy outcome**: Gaining robustness against rare adversarial attacks sacrifices **`{python} RobustnessTaxAnalysis.acc_drop_str` accuracy points of accuracy** on normal inputs.
