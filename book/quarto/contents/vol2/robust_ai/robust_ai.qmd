...
::: {#def-robust-ai-robust-ai .callout-definition title="Robust AI"}
...
# │
# │ Imports: mlsysim.core.constants (*), mlsysim.fmt (check)
# │ Exports: gpt3_params_b, v100_mem_bw, bits_per_second_str,
# │          expected_errors_per_hour
# └─────────────────────────────────────────────────────────────────────────────
...
# │ Exports: p_per_hr_str, n_gpus_large_str, p_total_large_str,
# │          n_gpus_certain_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │
# │ Imports: statistics (NormalDist), mlsysim.fmt (check)
# │ Exports: ds_mean_diff_str, ds_std_error_str, ds_z_score_str,
# │          ds_n_samples_str, ds_p_value_str, ds_shift_detected_str
# └─────────────────────────────────────────────────────────────────────────────
...
class ShiftConfidence:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    ds_mean_diff_str = f"{mean_diff:.2f}"
    ds_std_error_str = f"{std_error:.3f}"
    ds_z_score_str = f"{z_score:.1f}"
...
::: {#def-robust-ai-concept-drift .callout-definition title="Concept drift"}
...
::: {#def-robust-ai-adversarial-attack .callout-definition title="Adversarial attack"}
...
::: {#ws-robust-ai-stop-sign-attack .callout-war-story title="The stop sign attack"}
...
::: {#def-robust-ai-data-poisoning .callout-definition title="Data poisoning"}
...
::: {#chk-robust-ai-knowledge-check .callout-checkpoint title="Knowledge check"}
...
class RandomizedSmoothingRadius:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    rs_p_top_str = f"{p_top:.3f}"
    rs_sigma_str = f"{sigma:.1f}"
    rs_radius_str = f"{radius:.1f}"
```
