...
**Accuracy outcome**: Gaining robustness against rare adversarial attacks sacrifices **`{python} RobustnessTaxAnalysis.acc_drop_str` percentage points** of clean accuracy on normal inputs.
