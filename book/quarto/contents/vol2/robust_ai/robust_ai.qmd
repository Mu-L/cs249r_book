...
For continuous features where binning may lose information, Kullback-Leibler (KL) divergence\index{KL Divergence!drift detection} provides a more direct measure of distributional difference. The KL divergence from distribution $P$ to distribution $Q$ is defined as:
