...
**The context**: Strava published a global activity heatmap built from aggregated user fitness traces, presenting the data as anonymized, high-level movement information.

**The failure**: In sparsely populated or sensitive locations, aggregation did not hide enough. Patterns of running and cycling activity revealed military bases, patrol routes, and potentially identifying routines.

**The consequence**: Strava reviewed privacy settings and feature behavior after the exposure, while military and government organizations reassessed how consumer telemetry could leak operational information.

**The systems lesson**: Privacy failures can occur without names, passwords, or model weights leaking. High-dimensional location traces remain identifying when the context is sparse and the adversary can combine them with outside knowledge [@russell2018strava].
