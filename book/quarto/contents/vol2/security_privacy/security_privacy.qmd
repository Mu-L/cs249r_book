...
Each layer of this stack, shown in @fig-defense-stack, builds on the trust guarantees of the layer below it: data-level privacy techniques such as differential privacy and federated learning are only as secure as the runtime monitoring, model protections, and hardware trust anchors (TEEs, HSMs, PUFs) that support them.\index{Layered Defense Stack}
