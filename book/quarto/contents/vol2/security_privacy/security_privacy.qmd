...
class TEEMemoryFootprint:
    ...
    sgx_epc_mb = Hardware.Cloud.IntelSGX.memory.capacity.m_as(MB)
    sgx_latency_base_ms = Hardware.Cloud.IntelSGX.dispatch_tax.m_as(ms)
    sgx_latency_overflow_ms = Hardware.Cloud.IntelSGX.dispatch_tax.m_as(ms)
