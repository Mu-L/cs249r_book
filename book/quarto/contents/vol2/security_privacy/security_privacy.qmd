...
class MultiTenantIsolation:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    mt_peak_tokens_str = fmt(peak_throughput, precision=0, suffix=' tokens')
    mt_secure_tokens_str = fmt(secure_throughput, precision=0, suffix=' tokens')
    mt_throughput_loss_str = fmt(throughput_loss, precision=0, suffix=' tokens')
    mt_overhead_pct_str = fmt(overhead_pct, precision=0, commas=False, suffix=' percent')
```
...
::: {.callout-checkpoint title="Knowledge check: Threat modeling"}
...
3.  **Common pitfall**: Treating rate limiting alone as sufficient defense. An attacker willing to issue queries slowly, distribute requests across accounts, or accept a multi-month attack window can still extract a model unless the API also reduces output information per query (truncating logits, returning categorical confidence bins) and prices queries to make extraction economically irrational (@sec-security-privacy-api-design-information-leakage-minimization-8e32).
...
class DefenseOverheadAnalysis:
    ...
    training_cost_k_str = fmt(training_cost_usd/ THOUSAND, precision=0, commas=False, suffix="K")
    ...
    attacker_daily_queries_str = fmt(attacker_daily_queries/ THOUSAND, precision=0, commas=False, suffix="K")
    ...
    paid_tier_queries_str = fmt(paid_tier_queries/ THOUSAND, precision=0, commas=False, suffix="K")
    alert_queries_per_day_str = fmt(alert_queries_per_day/ THOUSAND, precision=0, commas=False, suffix="K")
    ...
    extraction_cost_k_str = fmt(extraction_cost_usd/ THOUSAND, precision=0, commas=False, suffix="K")
    ...
    monitoring_ms_str = fmt(monitoring_ms, precision=0, commas=False, suffix=" ms")
    perturbation_ms_str = fmt(perturbation_ms, precision=1, commas=False, suffix=" ms")
    base_inference_ms_str = fmt(base_inference_ms, precision=0, commas=False, suffix=" ms")
    total_defense_ms_str = fmt(total_defense_ms, precision=1, commas=False, suffix=" ms")
...
::: {.callout-checkpoint title="Knowledge check: Model attacks"}
...
::: {.callout-checkpoint title="Knowledge check: Hardware security"}
...
class TEEMemoryFootprint:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    resnet18_fp32_mb_str = fmt(resnet18_fp32_mb, precision=1, commas=False, suffix=' MB')
    resnet18_int8_mb_str = fmt(resnet18_int8_mb, precision=1, commas=False, suffix=' MB')
    resnet50_fp32_mb_str = fmt(resnet50_fp32_mb, precision=1, commas=False, suffix=' MB')
    resnet50_int8_mb_str = fmt(resnet50_int8_mb, precision=1, commas=False, suffix=' MB')
    ...
    sgx_epc_mb_str = fmt(sgx_epc_mb, precision=0, commas=False, suffix=' MB')
    resnet50_fp32_epc_pct_str = fmt(resnet50_fp32_epc_pct, precision=0, commas=False, suffix=' percent')
    sgx_latency_base_ms_str = fmt(sgx_latency_base_ms, precision=0, commas=False, suffix=' ms')
    sgx_latency_overflow_ms_str = fmt(sgx_latency_overflow_ms, precision=0, commas=False, suffix=' ms')
    small_model_limit_mb_str = fmt(small_model_limit_mb, precision=0, commas=False, suffix=' MB')
```
...
class EncryptionOverhead:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    eo_base_ms_str = fmt(t_inference_ms, precision=0, commas=False, suffix=' ms')
    eo_aes_overhead_ms_str = fmt(overhead_aes_ms, precision=1, commas=False, suffix=' ms')
    eo_aes_ms_str = fmt(t_aes, precision=1, commas=False, suffix=' ms')
    eo_fhe_sec_str = fmt(t_fhe_sec, precision=0, commas=False, suffix=' seconds')
