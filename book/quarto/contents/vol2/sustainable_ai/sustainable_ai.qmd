...
# │
# │ Imports: mlsysim.core.constants (ENERGY_EFF_{CPU,GPU,TPU,ASIC}_PJ_PER_FLOP)
# │ Exports: cpu_pj_per_flop, gpu_pj_per_flop, tpu_pj_per_flop,
# │          asic_pj_per_flop, efficiency_range_str
# └─────────────────────────────────────────────────────────────────────────────

# ┌── LEGO ───────────────────────────────────────────────
from mlsysim.core.constants import (ENERGY_EFF_CPU_PJ_PER_FLOP,
    ENERGY_EFF_GPU_PJ_PER_FLOP, ENERGY_EFF_TPU_PJ_PER_FLOP, ENERGY_EFF_ASIC_PJ_PER_FLOP)

class EnergyEfficiencyRange:
    """Namespace for hardware energy efficiency range across CPU to ASIC."""

    # ┌── 1. LOAD (Constants) ──────────────────────────────────────────────
    # Architecture-class efficiency hierarchy — single source of truth: mlsysim.
    cpu_pj_per_flop = ENERGY_EFF_CPU_PJ_PER_FLOP.m_as('picojoule/flop')
    gpu_pj_per_flop = ENERGY_EFF_GPU_PJ_PER_FLOP.m_as('picojoule/flop')
    tpu_pj_per_flop = ENERGY_EFF_TPU_PJ_PER_FLOP.m_as('picojoule/flop')
    asic_pj_per_flop = ENERGY_EFF_ASIC_PJ_PER_FLOP.m_as('picojoule/flop')
