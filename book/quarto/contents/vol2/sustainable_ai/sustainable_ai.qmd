...
**The context**: Ireland became a major data-center market, concentrating large electricity loads near Dublin while AI and cloud demand continued to rise.

**The failure**: Grid expansion did not keep pace with connection demand. Ireland's government reported that EirGrid was aware of up to 1 GW of prospective data-center projects and that Dublin's transmission system had been pushed to its limit.

**The consequence**: New data-center connections became a grid-planning and policy constraint rather than a normal procurement step, with location and reinforcement requirements shaping what could be built.

**The systems lesson**: Sustainable AI is constrained by interconnection, geography, and power-system adequacy. Efficient accelerators help, but the fleet cannot scale faster than the grid that feeds it [@ireland2022datacentres; @iea2024datacentresireland].
...
$$\text{AI} = \frac{\text{Total FLOPs}}{\text{Total Bytes Moved}}$$ {#eq-energy-arithmetic-intensity}
