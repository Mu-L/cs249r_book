...
**Systems conclusion**: A single training run emits as much carbon as hundreds of trans-Atlantic passenger round trips. **Optimization matters.** Moving this job to a hydro-powered region (0.02 kg/kWh) would reduce emissions by **`{python} CarbonCostGPT3.emissions_ratio_str`$\times$** to about 25 passenger round trips.
...
The optimizer shows how policy converts carbon into a placement cost; the same arithmetic also explains why region choice alone can dominate a workload's footprint.
