...
**Context**: Ireland became a major data-center market, concentrating large electricity loads near Dublin while AI and cloud demand continued to rise [@ireland2022datacentres; @iea2024datacentresireland].

**Failure**: Grid expansion did not keep pace with connection demand. Ireland's government and EirGrid reported multiple gigawatts of prospective data-center load concentrated near Dublin, with the local transmission system pushed to its limit.

**Consequence**: New data-center connections became a grid-planning and policy constraint rather than a normal procurement step, with location and reinforcement requirements shaping what could be built.

**Systems lesson**: Sustainable AI is constrained by interconnection, geography, and power-system adequacy. Efficient accelerators help, but the fleet cannot scale faster than the grid that feeds it.
