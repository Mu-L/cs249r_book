...
$$P_{\text{average}} = P_{\text{active}} \times D_{\text{duty}} + P_{\text{idle}} \times (1 - D_{\text{duty}})$$ {#eq-edge-duty-cycle}

where $D_{\text{duty}}$ is the duty cycle (fraction of time performing inference).
...
$$D_{\text{duty}} = \frac{5 \text{ ms}}{100 \text{ ms}} = 0.05 \text{ (5\% duty cycle)}$$
