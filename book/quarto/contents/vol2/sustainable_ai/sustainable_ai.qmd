...
| **DRAM**\index{DRAM}         |                   160 pJ/byte |        200-300 cycles |
...
# │
# │ Imports: mlsysim.core.constants (ENERGY_EFF_GPU_PJ_PER_FLOP,
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.core.constants import ENERGY_EFF_GPU_PJ_PER_FLOP, ENERGY_DRAM_PJ_PER_BYTE, BYTES_FP32
from mlsysim.fmt import fmt, MarkdownStr, check

class MatMulEnergyAnalysis:
    # ┌── 1. LOAD (Constants) ──────────────────────
    e_compute = ENERGY_EFF_GPU_PJ_PER_FLOP.m_as('picojoule/flop')   # 10 (effective)
