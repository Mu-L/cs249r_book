...
|-----|---------|--------|-------|------|----------|------|-------|----------|---|-------|
| vol1 | appendix_algorithm | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 5.6 | OK — build + HTML clean + LEGO/registry consistent |
| vol1 | appendix_assumptions | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 4.9 | OK — build + HTML clean + LEGO/registry consistent |
| vol1 | appendix_dam | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 4.8 | OK — build + HTML clean + LEGO/registry consistent |
| vol1 | appendix_data | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 5.6 | OK — build + HTML clean + LEGO/registry consistent |
...
| vol1 | ml_ops | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 18.9 | OK — build + HTML clean + LEGO/registry consistent |
| vol1 | ml_systems | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 17.5 | OK — build + HTML clean + LEGO/registry consistent |
| vol1 | ml_workflow | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 11.2 | OK — build + HTML clean + LEGO/registry consistent |
| vol1 | model_compression | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 39.3 | OK — build + HTML clean + LEGO/registry consistent |
| vol1 | model_serving | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 12.1 | OK — build + HTML clean + LEGO/registry consistent |
...
| vol2 | collective_communication | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 8.1 | OK — build + HTML clean + LEGO/registry consistent |
...
| vol2 | performance_engineering | **pass** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 8.5 | OK — build + HTML clean + LEGO/registry consistent |
