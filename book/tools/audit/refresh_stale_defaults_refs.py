...
_REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("mlsysim.core.defaults.REFERENCE_MFU_SUSTAINED", "mlsysim.core.calibration.REFERENCE_MFU_SUSTAINED"),
    ...
    ("mlsysim.core.defaults.FrameworkOverhead.python_dispatch", "mlsysim.core.calibration.KERNEL_LAUNCH_LATENCY_US"),
