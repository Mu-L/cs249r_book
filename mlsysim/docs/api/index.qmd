...
| [models.types.SparseTransformerWorkload](models.types.SparseTransformerWorkload.qmd#mlsysim.models.types.SparseTransformerWorkload) | Sparse Transformer / MoE workload type. |
| [infra](infra.qmd#mlsysim.infra) |  |
| [systems](systems.qmd#mlsysim.systems) |  |
| [platforms](platforms.qmd#mlsysim.platforms) | Deployment paradigm envelopes (Cloud, Edge, Mobile, TinyML). |
| [datasets](datasets.qmd#mlsysim.datasets) | Dataset size and resolution profiles. |
| [literature](literature.qmd#mlsysim.literature) | Cited MFU, Chinchilla, and scaling anchors. |
| [ops](ops.qmd#mlsysim.ops) | MLOps monitoring thresholds. |
| [physics](physics.qmd#mlsysim.physics) | Closed-form physics formulas. |
...
| [core.solver.TrainingMemoryModel](core.solver.TrainingMemoryModel.qmd#mlsysim.core.solver.TrainingMemoryModel) | Decomposes per-accelerator training memory into weights, gradients, optimizer state, activations, and buffers. |
| [core.solver.ServingCapacityModel](core.solver.ServingCapacityModel.qmd#mlsysim.core.solver.ServingCapacityModel) | Sizes an LLM serving deployment from QPS and tail-latency targets. |
...
| [core.solver.MoERoutingModel](core.solver.MoERoutingModel.qmd#mlsysim.core.solver.MoERoutingModel) | Models MoE routing imbalance and expert-parallel all-to-all cost. |
