...
::: {.callout-note}
## Physics formulas
Closed-form equations live in **`mlsysim.physics.*`** (performance, memory, communication,
serving, economics, reliability). `mlsysim.core.constants` holds units and cross-cutting
laws only — not chip or model specs. See [Math Foundations](math.qmd).
:::
...
| [Performance Engineering](https://mlsysbook.ai/slides/vol2.html) (Vol II, Ch 9) | Match the software to the silicon | Operator fusion, FlashAttention, mixed precision, systematic profiling workflow |
| [Inference at Scale](https://mlsysbook.ai/slides/vol2.html) (Vol II, Ch 10) | Where ML systems live or die economically | Serving economics, KV-cache bottleneck, batching strategies, autoscaling |
...
|:---|:-----|:------------------|:---------|
| 5 | NN Computation | A (Workloads) | [PDF]({{< var slides_latest >}}/vol1_05_nn_computation.pdf) |
| 6 | NN Architectures | A (Workloads) | [PDF]({{< var slides_latest >}}/vol1_06_nn_architectures.pdf) |
| 8 | Model Training | A + B + E | [PDF]({{< var slides_latest >}}/vol1_08_training.pdf) |
| 10 | Model Compression | A (Workloads) | [PDF]({{< var slides_latest >}}/vol1_10_model_compression.pdf) |
| 11 | Hardware Acceleration | B (Hardware) + E (Solvers) | [PDF]({{< var slides_latest >}}/vol1_11_hw_acceleration.pdf) |
| 12 | Benchmarking | B (Hardware) + E (Solvers) | [PDF]({{< var slides_latest >}}/vol1_12_benchmarking.pdf) |
| 13 | Model Serving | E (Solvers) | [PDF]({{< var slides_latest >}}/vol1_13_model_serving.pdf) |

### Volume II: At Scale

| Ch | Deck | MLSYSIM Layer(s) | Download |
|:---|:-----|:------------------|:---------|
| 2 | Compute Infrastructure | B (Hardware) | [PDF]({{< var slides_latest >}}/vol2_02_compute_infrastructure.pdf) |
| 3 | Network Fabrics | D (Systems) | [PDF]({{< var slides_latest >}}/vol2_03_network_fabrics.pdf) |
| 5 | Distributed Training | D (Systems) + E (Solvers) | [PDF]({{< var slides_latest >}}/vol2_05_distributed_training.pdf) |
| 6 | Collective Communication | D (Systems) | [PDF]({{< var slides_latest >}}/vol2_06_collective_communication.pdf) |
| 8 | Fleet Orchestration | D (Systems) | [PDF]({{< var slides_latest >}}/vol2_08_fleet_orchestration.pdf) |
| 9 | Performance Engineering | E (Solvers) | [PDF]({{< var slides_latest >}}/vol2_09_performance_engineering.pdf) |
| 10 | Inference at Scale | E (Solvers) | [PDF]({{< var slides_latest >}}/vol2_10_inference.pdf) |
| 15 | Sustainable AI | C (Infrastructure) | [PDF]({{< var slides_latest >}}/vol2_15_sustainable_ai.pdf) |
