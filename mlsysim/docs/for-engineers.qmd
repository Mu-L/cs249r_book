...
MLSYSIM gives you quick, type-safe analytical estimates for capacity planning, hardware selection, cost modeling, and sustainability analysis -- in seconds, from specifications alone. Equations are documented and tied to the relevant literature; hardware registry specs come from datasheets where available.
...
The `Engine` implements the [Roofline Performance Model]({{< var slides_latest >}}/vol1_11_hw_acceleration.pdf){target="_blank"} (Williams et al. 2009) to classify workloads as compute-bound or memory-bound.
...
The `ServingModel` models the [two-phase LLM inference lifecycle]({{< var slides_latest >}}/vol1_13_model_serving.pdf){target="_blank"}: compute-bound pre-fill and memory-bound decoding.
...
The `DistributedModel` models [3D parallelism]({{< var slides_latest >}}/vol2_05_distributed_training.pdf){target="_blank"} (data, tensor, pipeline) with communication overhead from [ring all-reduce]({{< var slides_latest >}}/vol2_06_collective_communication.pdf){target="_blank"} and pipeline bubbles.
...
For the theory behind PUE, carbon intensity, and the energy hierarchy, see the [Sustainable AI]({{< var slides_latest >}}/vol2_15_sustainable_ai.pdf){target="_blank"} slide deck.
...
This solver implements the [Young-Daly checkpoint model]({{< var slides_latest >}}/vol2_07_fault_tolerance.pdf){target="_blank"} -- essential for capacity planning on long training jobs.
...
|:---------------|:---------------|:-----------|
| Engine / SingleNodeModel | Roofline analysis, compute vs. memory bottleneck | [Hardware Acceleration (Vol I, Ch 11)]({{< var slides_latest >}}/vol1_11_hw_acceleration.pdf){target="_blank"} |
| ServingModel | TTFT, ITL, KV-cache memory | [Model Serving (Vol I, Ch 13)]({{< var slides_latest >}}/vol1_13_model_serving.pdf){target="_blank"} and [Inference at Scale (Vol II, Ch 10)]({{< var slides_latest >}}/vol2_10_inference.pdf){target="_blank"} |
| DistributedModel | 3D parallelism, all-reduce, pipeline bubbles | [Distributed Training (Vol II, Ch 5)]({{< var slides_latest >}}/vol2_05_distributed_training.pdf){target="_blank"} and [Collective Communication (Vol II, Ch 6)]({{< var slides_latest >}}/vol2_06_collective_communication.pdf){target="_blank"} |
| EconomicsModel | CapEx, OpEx, total cost of ownership | [Compute Infrastructure (Vol II, Ch 2)]({{< var slides_latest >}}/vol2_02_compute_infrastructure.pdf){target="_blank"} |
| SustainabilityModel | Energy, carbon footprint, water usage | [Sustainable AI (Vol II, Ch 15)]({{< var slides_latest >}}/vol2_15_sustainable_ai.pdf){target="_blank"} |
| ReliabilityModel | MTBF, Young-Daly checkpointing | [Fault Tolerance (Vol II, Ch 7)]({{< var slides_latest >}}/vol2_07_fault_tolerance.pdf){target="_blank"} |
...
[Browse Vol I Decks](https://mlsysbook.ai/slides/vol1.html){target="_blank"} | [Download All (PDF)]({{< var slides_latest >}}/MLSysBook-Slides-Vol1-PDF.zip){target="_blank"}
:::

::: {.column width="50%"}
**Volume II: At Scale** (18 decks, 529 slides)

[Browse Vol II Decks](https://mlsysbook.ai/slides/vol2.html){target="_blank"} | [Download All (PDF)]({{< var slides_latest >}}/MLSysBook-Slides-Vol2-PDF.zip){target="_blank"}
:::
