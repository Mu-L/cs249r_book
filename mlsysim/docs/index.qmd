...
The slide decks, MLSys·im engine, tutorials, and textbook are all part of the same open-source ecosystem. Cite the textbook separately when you use the book or course materials. [View all resources on GitHub.](https://github.com/harvard-edge/cs249r_book){target="_blank"}
