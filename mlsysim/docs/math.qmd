...
*Used by [`mlsysim.physics.calc_transformer_training_flops`](https://github.com/harvard-edge/cs249r_book/blob/dev/mlsysim/mlsysim/mlsysim/physics/).*
...
*Implemented in [`mlsysim.physics.calc_failure_probability`](https://github.com/harvard-edge/cs249r_book/blob/dev/mlsysim/mlsysim/mlsysim/physics/).*
...
*Implemented in [`mlsysim.physics.calc_effective_flops`](https://github.com/harvard-edge/cs249r_book/blob/dev/mlsysim/mlsysim/mlsysim/physics/).*
