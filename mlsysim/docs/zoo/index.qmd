...
| **Platforms** | Deployment paradigms (Cloud, Edge, Mobile, TinyML) | Latency range, RAM envelope | `mlsysim.Platforms.Cloud.latency_range_ms` |
...
| **Literature** | Cited scaling laws, MFU bands, communication models | Chinchilla, ring AllReduce factor | `mlsysim.Literature.Chinchilla.TokensPerParam` |
| **Ops** | Monitoring and drift thresholds for fleet operations | PSI, KS, BER anchors | `mlsysim.Ops.Monitoring.PsiWarnThreshold` |
| **Calibration** | Solver/engine knobs (not hardware specs) | Reference MFU, kernel launch latency | `mlsysim.core.calibration.REFERENCE_MFU_SUSTAINED` |
...
ref_mfu = mlsysim.core.calibration.REFERENCE_MFU_SUSTAINED
```
