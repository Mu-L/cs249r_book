...
The \textbf{Hardware} registry records provenance metadata for release-facing hardware entries where primary vendor sources are available, and the registry schema reserves \texttt{metadata.source\_url} and \texttt{metadata.last\_verified} fields for this traceability. This keeps datasheet-backed constants auditable while allowing clearly marked estimates for emerging or difficult-to-source hardware.
