...
\begin{table}[!ht]
\centering
\caption{\textbf{Hardware Registry.} All registered accelerators organized by deployment tier. Peak FLOP/s is FP16 Tensor Core (or equivalent) throughput; BW is HBM (or on-die SRAM for wafer-scale/tiny) bandwidth.\protect\footnotemark\ The last row shows a user-defined custom entry (Listing~\ref{lst:hwnode}).}
