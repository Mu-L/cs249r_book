...
\begin{frame}[shrink]{The Algebra of Distributed Overheads}
...
\begin{frame}[shrink]{Why Distribute?}
...
\begin{frame}[shrink]{3D Parallelism: DP $\times$ TP $\times$ PP}
...
\begin{frame}[fragile,shrink=10]{AllReduce: A Concrete Example}
...
\begin{frame}[shrink]{Wall 14: The Communication Wall (AllReduce)}
...
\begin{frame}[shrink]{Tensor Parallelism: Splitting Layers}
...
\begin{frame}[shrink]{Pipeline Parallelism: The Bubble Problem}
...
\begin{frame}[shrink]{Gradient Accumulation: Virtual Batch Size}
...
\begin{frame}[shrink]{Hierarchical AllReduce: NVLink + InfiniBand}
...
\begin{frame}[fragile,shrink=10]{Live Demo: Distributed Training Analysis}
...
\begin{frame}[shrink]{Wall 15: The Fragility Wall (Reliability)}
...
\begin{frame}[shrink]{Predict: Scaling to 256 GPUs}
...
\begin{frame}[shrink]{Scaling Efficiency: The Amdahl Trap}
...
\begin{frame}[shrink]{Predict: Optimal Parallelism Config}
...
\begin{frame}[fragile,shrink=10]{Exercise 4: Distributed Training Design}
...
\begin{frame}[shrink]{Stragglers: The Slowest GPU Sets the Pace}
...
\begin{frame}[shrink]{Part 4: Key Takeaway}
...
\begin{frame}[fragile,shrink=10]{Wall 17: The Capital Wall (TCO)}
...
\begin{frame}[shrink]{The Infrastructure Multiplier}
...
\begin{frame}[fragile,shrink=10]{Wall 18: The Sustainability Wall}
...
\begin{frame}[shrink]{Carbon Intensity: The 41$\times$ Gap}
...
% --- 5.6 Embodied Carbon ---
\begin{frame}[shrink]{Embodied Carbon: Manufacturing Dominates at the Edge}
...
\begin{frame}[fragile,shrink=10]{Live Demo: TCO + Carbon Analysis}
...
\begin{frame}[fragile,shrink=10]{Live Demo: The Carbon Geography Experiment}
...
\begin{frame}[fragile,shrink=10]{Exercise 5a: Carbon-Aware Placement}
...
\begin{frame}[fragile,shrink=10]{Exercise 5b: Multi-Vendor TCO Shootout}
...
% --- 5.10 Takeaway ---
\begin{frame}[shrink]{Key Takeaway: Economics \& Sustainability}
...
\begin{frame}[fragile,shrink=10]{Cross-Domain Carbon Accounting (Scenario B)}
