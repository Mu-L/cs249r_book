...
description: "TinyML pedagogy from a secondary school robotics classroom in British Columbia, where the instructor is a generalist, failure is part of the curriculum, and the classroom functions like a small R&D lab."
draft: true
---
...
<!--
  TODOs before push:
    ...
    2. Add cover image (drafts/figures/...) or pick one in the Buttondown UI.
    3. Replace the [XIAO ML Kit Course](TBD) link in the bio block with the
       real GitHub URL.
-->
